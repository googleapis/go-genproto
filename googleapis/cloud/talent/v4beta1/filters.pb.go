...
func (LocationFilter_TelecommutePreference) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_filters_5edfe4d452e3ea13, []int{2, 0}
}
...
func (CompensationFilter_FilterType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_filters_5edfe4d452e3ea13, []int{3, 0}
}
...
func (CommuteFilter_RoadTraffic) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_filters_5edfe4d452e3ea13, []int{4, 0}
}
...
func (EmployerFilter_EmployerFilterMode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_filters_5edfe4d452e3ea13, []int{7, 0}
}
...
func (TimeFilter_TimeField) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_filters_5edfe4d452e3ea13, []int{13, 0}
}
...
func (*JobQuery) Descriptor() ([]byte, []int) {
	return fileDescriptor_filters_5edfe4d452e3ea13, []int{0}
}
...
func (*ProfileQuery) Descriptor() ([]byte, []int) {
	return fileDescriptor_filters_5edfe4d452e3ea13, []int{1}
}
...
func (*LocationFilter) Descriptor() ([]byte, []int) {
	return fileDescriptor_filters_5edfe4d452e3ea13, []int{2}
}
...
func (*CompensationFilter) Descriptor() ([]byte, []int) {
	return fileDescriptor_filters_5edfe4d452e3ea13, []int{3}
}
...
func (*CommuteFilter) Descriptor() ([]byte, []int) {
	return fileDescriptor_filters_5edfe4d452e3ea13, []int{4}
}
...
func (*JobTitleFilter) Descriptor() ([]byte, []int) {
	return fileDescriptor_filters_5edfe4d452e3ea13, []int{5}
}
...
func (*SkillFilter) Descriptor() ([]byte, []int) {
	return fileDescriptor_filters_5edfe4d452e3ea13, []int{6}
}
...
func (*EmployerFilter) Descriptor() ([]byte, []int) {
	return fileDescriptor_filters_5edfe4d452e3ea13, []int{7}
}
...
func (*EducationFilter) Descriptor() ([]byte, []int) {
	return fileDescriptor_filters_5edfe4d452e3ea13, []int{8}
}
...
func (*WorkExperienceFilter) Descriptor() ([]byte, []int) {
	return fileDescriptor_filters_5edfe4d452e3ea13, []int{9}
}
...
func (*ApplicationDateFilter) Descriptor() ([]byte, []int) {
	return fileDescriptor_filters_5edfe4d452e3ea13, []int{10}
}
...
func (*ApplicationOutcomeNotesFilter) Descriptor() ([]byte, []int) {
	return fileDescriptor_filters_5edfe4d452e3ea13, []int{11}
}
...
func (*ApplicationJobFilter) Descriptor() ([]byte, []int) {
	return fileDescriptor_filters_5edfe4d452e3ea13, []int{12}
}
...
func (*TimeFilter) Descriptor() ([]byte, []int) {
	return fileDescriptor_filters_5edfe4d452e3ea13, []int{13}
}
...
func init() {
	proto.RegisterFile("google/cloud/talent/v4beta1/filters.proto", fileDescriptor_filters_5edfe4d452e3ea13)
}

var fileDescriptor_filters_5edfe4d452e3ea13 = []byte{
