...
func (*HistogramQuery) Descriptor() ([]byte, []int) {
	return fileDescriptor_histogram_f500a81f75ea8888, []int{0}
}
...
func (*HistogramQueryResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_histogram_f500a81f75ea8888, []int{1}
}
...
func init() {
	proto.RegisterFile("google/cloud/talent/v4beta1/histogram.proto", fileDescriptor_histogram_f500a81f75ea8888)
}

var fileDescriptor_histogram_f500a81f75ea8888 = []byte{
