...
func (JobEvent_JobEventType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_event_47b077ed1a38250b, []int{1, 0}
}
...
func (ProfileEvent_ProfileEventType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_event_47b077ed1a38250b, []int{2, 0}
}
...
func (*ClientEvent) Descriptor() ([]byte, []int) {
	return fileDescriptor_event_47b077ed1a38250b, []int{0}
}
...
func (*JobEvent) Descriptor() ([]byte, []int) {
	return fileDescriptor_event_47b077ed1a38250b, []int{1}
}
...
func (*ProfileEvent) Descriptor() ([]byte, []int) {
	return fileDescriptor_event_47b077ed1a38250b, []int{2}
}
...
func init() {
	proto.RegisterFile("google/cloud/talent/v4beta1/event.proto", fileDescriptor_event_47b077ed1a38250b)
}

var fileDescriptor_event_47b077ed1a38250b = []byte{
