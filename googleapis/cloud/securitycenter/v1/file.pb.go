...
var file_google_cloud_securitycenter_v1_file_proto_rawDesc = []byte{
	...
	0x74, 0x79, 0x63, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x22, 0xae, 0x01, 0x0a, 0x04,
	...
	0x28, 0x09, 0x52, 0x08, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x73, 0x42, 0xe5, 0x01, 0x0a,
...
var file_google_cloud_securitycenter_v1_file_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_cloud_securitycenter_v1_file_proto_goTypes = []interface{}{
...
func file_google_cloud_securitycenter_v1_file_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_securitycenter_v1_file_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*File); i {
			case 0:
				return &v.state
			case 1:
