...
func (*SecurityMarks) Descriptor() ([]byte, []int) {
	return fileDescriptor_security_marks_89566b31649909af, []int{0}
}
...
func init() {
	proto.RegisterFile("google/cloud/securitycenter/v1beta1/security_marks.proto", fileDescriptor_security_marks_89566b31649909af)
}

var fileDescriptor_security_marks_89566b31649909af = []byte{
