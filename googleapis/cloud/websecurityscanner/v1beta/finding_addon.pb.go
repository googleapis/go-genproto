...
func (dst *VulnerableHeaders) XXX_Merge(src proto.Message) {
	xxx_messageInfo_VulnerableHeaders.Merge(dst, src)
}
...
func (dst *VulnerableHeaders_Header) XXX_Merge(src proto.Message) {
	xxx_messageInfo_VulnerableHeaders_Header.Merge(dst, src)
}
