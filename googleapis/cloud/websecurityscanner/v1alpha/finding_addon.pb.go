...
func (*OutdatedLibrary) Descriptor() ([]byte, []int) {
	return fileDescriptor_finding_addon_0a47c25fab663451, []int{0}
}
...
func (*ViolatingResource) Descriptor() ([]byte, []int) {
	return fileDescriptor_finding_addon_0a47c25fab663451, []int{1}
}
...
func (*VulnerableParameters) Descriptor() ([]byte, []int) {
	return fileDescriptor_finding_addon_0a47c25fab663451, []int{2}
}
...
func (*Xss) Descriptor() ([]byte, []int) {
	return fileDescriptor_finding_addon_0a47c25fab663451, []int{3}
}
...
func init() {
	proto.RegisterFile("google/cloud/websecurityscanner/v1alpha/finding_addon.proto", fileDescriptor_finding_addon_0a47c25fab663451)
}

var fileDescriptor_finding_addon_0a47c25fab663451 = []byte{
