...
func (*CrawledUrl) Descriptor() ([]byte, []int) {
	return fileDescriptor_crawled_url_fd7b6fb38bf10fe0, []int{0}
}
...
func init() {
	proto.RegisterFile("google/cloud/websecurityscanner/v1alpha/crawled_url.proto", fileDescriptor_crawled_url_fd7b6fb38bf10fe0)
}

var fileDescriptor_crawled_url_fd7b6fb38bf10fe0 = []byte{
