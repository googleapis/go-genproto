...
type Metric_MetricSource int32

const (
	// Unspecified metric source
	Metric_METRIC_SOURCE_UNSPECIFIED Metric_MetricSource = 0
	...
	Metric_MONITORING_AGENT_DEFAULTS Metric_MetricSource = 1
	// HDFS metric source
	Metric_HDFS Metric_MetricSource = 2
	// SPARK metric source
	Metric_SPARK Metric_MetricSource = 3
	// YARN metric source
	Metric_YARN Metric_MetricSource = 4
	// Spark History Server metric source
	Metric_SPARK_HISTORY_SERVER Metric_MetricSource = 5
	// Hiveserver2 metric source
	Metric_HIVESERVER2 Metric_MetricSource = 6
)

// Enum value maps for Metric_MetricSource.
var (
	Metric_MetricSource_name = map[int32]string{
	...
	Metric_MetricSource_value = map[string]int32{
...
func (x Metric_MetricSource) Enum() *Metric_MetricSource {
	p := new(Metric_MetricSource)
	*p = x
	return p
}

func (x Metric_MetricSource) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (Metric_MetricSource) Descriptor() protoreflect.EnumDescriptor {
	return file_google_cloud_dataproc_v1_clusters_proto_enumTypes[4].Descriptor()
}

func (Metric_MetricSource) Type() protoreflect.EnumType {
	return &file_google_cloud_dataproc_v1_clusters_proto_enumTypes[4]
}

func (x Metric_MetricSource) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use Metric_MetricSource.Descriptor instead.
func (Metric_MetricSource) EnumDescriptor() ([]byte, []int) {
...
func (ReservationAffinity_Type) EnumDescriptor() ([]byte, []int) {
	return file_google_cloud_dataproc_v1_clusters_proto_rawDescGZIP(), []int{36, 0}
}
...
type ClusterConfig struct {
	...
	DataprocMetricConfig *DataprocMetricConfig `protobuf:"bytes,21,opt,name=dataproc_metric_config,json=dataprocMetricConfig,proto3" json:"dataproc_metric_config,omitempty"`
}
...
type Metric struct {
	...
	MetricSource Metric_MetricSource `protobuf:"varint,1,opt,name=metric_source,json=metricSource,proto3,enum=google.cloud.dataproc.v1.Metric_MetricSource" json:"metric_source,omitempty"`
...
func (x *Metric) GetMetricSource() Metric_MetricSource {
	if x != nil {
		return x.MetricSource
	}
	return Metric_METRIC_SOURCE_UNSPECIFIED
}

func (x *Metric) GetMetricOverrides() []string {
	if x != nil {
...
func (x *DataprocMetricConfig) GetMetrics() []*Metric {
	if x != nil {
		return x.Metrics
	}
	return nil
...
var file_google_cloud_dataproc_v1_clusters_proto_rawDesc = []byte{
	...
	,
...
var file_google_cloud_dataproc_v1_clusters_proto_goTypes = []interface{}{
	...
	(Metric_MetricSource)(0),                      // 4: google.cloud.dataproc.v1.Metric.MetricSource
	...
	(*Metric)(nil),                                // 29: google.cloud.dataproc.v1.Metric
	(*DataprocMetricConfig)(nil),                  // 30: google.cloud.dataproc.v1.DataprocMetricConfig
	(*ClusterMetrics)(nil),                        // 31: google.cloud.dataproc.v1.ClusterMetrics
	(*CreateClusterRequest)(nil),                  // 32: google.cloud.dataproc.v1.CreateClusterRequest
	(*UpdateClusterRequest)(nil),                  // 33: google.cloud.dataproc.v1.UpdateClusterRequest
	(*StopClusterRequest)(nil),                    // 34: google.cloud.dataproc.v1.StopClusterRequest
	(*StartClusterRequest)(nil),                   // 35: google.cloud.dataproc.v1.StartClusterRequest
	(*DeleteClusterRequest)(nil),                  // 36: google.cloud.dataproc.v1.DeleteClusterRequest
	(*GetClusterRequest)(nil),                     // 37: google.cloud.dataproc.v1.GetClusterRequest
	(*ListClustersRequest)(nil),                   // 38: google.cloud.dataproc.v1.ListClustersRequest
	(*ListClustersResponse)(nil),                  // 39: google.cloud.dataproc.v1.ListClustersResponse
	(*DiagnoseClusterRequest)(nil),                // 40: google.cloud.dataproc.v1.DiagnoseClusterRequest
	(*DiagnoseClusterResults)(nil),                // 41: google.cloud.dataproc.v1.DiagnoseClusterResults
	(*ReservationAffinity)(nil),                   // 42: google.cloud.dataproc.v1.ReservationAffinity
	nil,                                           // 43: google.cloud.dataproc.v1.Cluster.LabelsEntry
	nil,                                           // 44: google.cloud.dataproc.v1.EndpointConfig.HttpPortsEntry
	nil,                                           // 45: google.cloud.dataproc.v1.GceClusterConfig.MetadataEntry
	nil,                                           // 46: google.cloud.dataproc.v1.IdentityConfig.UserServiceAccountMappingEntry
	nil,                                           // 47: google.cloud.dataproc.v1.SoftwareConfig.PropertiesEntry
...
var file_google_cloud_dataproc_v1_clusters_proto_depIdxs = []int32{
	...
	43, // 2: google.cloud.dataproc.v1.Cluster.labels:type_name -> google.cloud.dataproc.v1.Cluster.LabelsEntry
	...
	31, // 5: google.cloud.dataproc.v1.Cluster.metrics:type_name -> google.cloud.dataproc.v1.ClusterMetrics
	...
	30, // 18: google.cloud.dataproc.v1.ClusterConfig.dataproc_metric_config:type_name -> google.cloud.dataproc.v1.DataprocMetricConfig
	...
	44, // 23: google.cloud.dataproc.v1.EndpointConfig.http_ports:type_name -> google.cloud.dataproc.v1.EndpointConfig.HttpPortsEntry
	...
	45, // 25: google.cloud.dataproc.v1.GceClusterConfig.metadata:type_name -> google.cloud.dataproc.v1.GceClusterConfig.MetadataEntry
	42, // 26: google.cloud.dataproc.v1.GceClusterConfig.reservation_affinity:type_name -> google.cloud.dataproc.v1.ReservationAffinity
	...
	46, // 40: google.cloud.dataproc.v1.IdentityConfig.user_service_account_mapping:type_name -> google.cloud.dataproc.v1.IdentityConfig.UserServiceAccountMappingEntry
	47, // 41: google.cloud.dataproc.v1.SoftwareConfig.properties:type_name -> google.cloud.dataproc.v1.SoftwareConfig.PropertiesEntry
	...
	4,  // 47: google.cloud.dataproc.v1.Metric.metric_source:type_name -> google.cloud.dataproc.v1.Metric.MetricSource
	29, // 48: google.cloud.dataproc.v1.DataprocMetricConfig.metrics:type_name -> google.cloud.dataproc.v1.Metric
	48, // 49: google.cloud.dataproc.v1.ClusterMetrics.hdfs_metrics:type_name -> google.cloud.dataproc.v1.ClusterMetrics.HdfsMetricsEntry
	49, // 50: google.cloud.dataproc.v1.ClusterMetrics.yarn_metrics:type_name -> google.cloud.dataproc.v1.ClusterMetrics.YarnMetricsEntry
	6,  // 51: google.cloud.dataproc.v1.CreateClusterRequest.cluster:type_name -> google.cloud.dataproc.v1.Cluster
	55, // 52: google.cloud.dataproc.v1.CreateClusterRequest.action_on_failed_primary_workers:type_name -> google.cloud.dataproc.v1.FailureAction
	6,  // 53: google.cloud.dataproc.v1.UpdateClusterRequest.cluster:type_name -> google.cloud.dataproc.v1.Cluster
	52, // 54: google.cloud.dataproc.v1.UpdateClusterRequest.graceful_decommission_timeout:type_name -> google.protobuf.Duration
	56, // 55: google.cloud.dataproc.v1.UpdateClusterRequest.update_mask:type_name -> google.protobuf.FieldMask
	6,  // 56: google.cloud.dataproc.v1.ListClustersResponse.clusters:type_name -> google.cloud.dataproc.v1.Cluster
	5,  // 57: google.cloud.dataproc.v1.ReservationAffinity.consume_reservation_type:type_name -> google.cloud.dataproc.v1.ReservationAffinity.Type
	32, // 58: google.cloud.dataproc.v1.ClusterController.CreateCluster:input_type -> google.cloud.dataproc.v1.CreateClusterRequest
	33, // 59: google.cloud.dataproc.v1.ClusterController.UpdateCluster:input_type -> google.cloud.dataproc.v1.UpdateClusterRequest
	34, // 60: google.cloud.dataproc.v1.ClusterController.StopCluster:input_type -> google.cloud.dataproc.v1.StopClusterRequest
	35, // 61: google.cloud.dataproc.v1.ClusterController.StartCluster:input_type -> google.cloud.dataproc.v1.StartClusterRequest
	36, // 62: google.cloud.dataproc.v1.ClusterController.DeleteCluster:input_type -> google.cloud.dataproc.v1.DeleteClusterRequest
	37, // 63: google.cloud.dataproc.v1.ClusterController.GetCluster:input_type -> google.cloud.dataproc.v1.GetClusterRequest
	38, // 64: google.cloud.dataproc.v1.ClusterController.ListClusters:input_type -> google.cloud.dataproc.v1.ListClustersRequest
	40, // 65: google.cloud.dataproc.v1.ClusterController.DiagnoseCluster:input_type -> google.cloud.dataproc.v1.DiagnoseClusterRequest
	...
	39, // 72: google.cloud.dataproc.v1.ClusterController.ListClusters:output_type -> google.cloud.dataproc.v1.ListClustersResponse
