...
func (OperationMetadata_OperationType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_operation_metadata_c111b6986797fe5f, []int{0, 0}
}
...
func (*OperationMetadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_operation_metadata_c111b6986797fe5f, []int{0}
}
...
func init() {
	proto.RegisterFile("google/cloud/ml/v1/operation_metadata.proto", fileDescriptor_operation_metadata_c111b6986797fe5f)
}

var fileDescriptor_operation_metadata_c111b6986797fe5f = []byte{
