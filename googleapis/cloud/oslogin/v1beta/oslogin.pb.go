...
func (*LoginProfile) Descriptor() ([]byte, []int) {
	return fileDescriptor_oslogin_e03b1f0aa7c54cba, []int{0}
}
...
func (*DeletePosixAccountRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_oslogin_e03b1f0aa7c54cba, []int{1}
}
...
func (*DeleteSshPublicKeyRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_oslogin_e03b1f0aa7c54cba, []int{2}
}
...
func (*GetLoginProfileRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_oslogin_e03b1f0aa7c54cba, []int{3}
}
...
func (*GetSshPublicKeyRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_oslogin_e03b1f0aa7c54cba, []int{4}
}
...
func (*ImportSshPublicKeyRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_oslogin_e03b1f0aa7c54cba, []int{5}
}
...
func (*ImportSshPublicKeyResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_oslogin_e03b1f0aa7c54cba, []int{6}
}
...
func (*UpdateSshPublicKeyRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_oslogin_e03b1f0aa7c54cba, []int{7}
}
...
var fileDescriptor_oslogin_e03b1f0aa7c54cba = []byte{
