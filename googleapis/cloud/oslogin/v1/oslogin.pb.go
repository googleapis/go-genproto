...
func (*LoginProfile) Descriptor() ([]byte, []int) {
	return fileDescriptor_oslogin_470b09e56a6f2815, []int{0}
}
...
func (*DeletePosixAccountRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_oslogin_470b09e56a6f2815, []int{1}
}
...
func (*DeleteSshPublicKeyRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_oslogin_470b09e56a6f2815, []int{2}
}
...
func (*GetLoginProfileRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_oslogin_470b09e56a6f2815, []int{3}
}
...
func (*GetSshPublicKeyRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_oslogin_470b09e56a6f2815, []int{4}
}
...
func (*ImportSshPublicKeyRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_oslogin_470b09e56a6f2815, []int{5}
}
...
func (*ImportSshPublicKeyResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_oslogin_470b09e56a6f2815, []int{6}
}
...
func (*UpdateSshPublicKeyRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_oslogin_470b09e56a6f2815, []int{7}
}
...
func init() {
	proto.RegisterFile("google/cloud/oslogin/v1/oslogin.proto", fileDescriptor_oslogin_470b09e56a6f2815)
}

var fileDescriptor_oslogin_470b09e56a6f2815 = []byte{
