...
func (*PosixAccount) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_085b2e433f956f98, []int{0}
}
...
func (*SshPublicKey) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_085b2e433f956f98, []int{1}
}
...
func init() {
	proto.RegisterFile("google/cloud/oslogin/common/common.proto", fileDescriptor_common_085b2e433f956f98)
}

var fileDescriptor_common_085b2e433f956f98 = []byte{
