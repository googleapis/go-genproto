...
func (*LoginProfile) Descriptor() ([]byte, []int) {
	return fileDescriptor_oslogin_16f0f854d7b09dcc, []int{0}
}
...
func (*DeletePosixAccountRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_oslogin_16f0f854d7b09dcc, []int{1}
}
...
func (*DeleteSshPublicKeyRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_oslogin_16f0f854d7b09dcc, []int{2}
}
...
func (*GetLoginProfileRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_oslogin_16f0f854d7b09dcc, []int{3}
}
...
func (*GetSshPublicKeyRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_oslogin_16f0f854d7b09dcc, []int{4}
}
...
func (*ImportSshPublicKeyRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_oslogin_16f0f854d7b09dcc, []int{5}
}
...
func (*ImportSshPublicKeyResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_oslogin_16f0f854d7b09dcc, []int{6}
}
...
func (*UpdateSshPublicKeyRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_oslogin_16f0f854d7b09dcc, []int{7}
}
...
func init() {
	proto.RegisterFile("google/cloud/oslogin/v1alpha/oslogin.proto", fileDescriptor_oslogin_16f0f854d7b09dcc)
}

var fileDescriptor_oslogin_16f0f854d7b09dcc = []byte{
