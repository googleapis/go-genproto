...
const (
	...
	Condition_ROUTE_MISSING Condition_CommonReason = 2
	...
	Condition_BUILD_STEP_FAILED Condition_CommonReason = 5
...
type Condition_InternalReason int32

const (
	// Default value.
	Condition_INTERNAL_REASON_UNDEFINED Condition_InternalReason = 0
	// The revision name provided conflicts with an existing one.
	Condition_CONFLICTING_REVISION_NAME Condition_InternalReason = 1
	// Revision is missing; this is usually a transient reason.
	Condition_REVISION_MISSING Condition_InternalReason = 2
	// Internal configuration is missing; this is usually a transient reason.
	Condition_CONFIGURATION_MISSING Condition_InternalReason = 3
	// Assigning traffic; this is a transient reason.
	Condition_ASSIGNING_TRAFFIC Condition_InternalReason = 4
	// Updating ingress traffic settings; this is a transient reason.
	Condition_UPDATING_INGRESS_TRAFFIC_ALLOWED Condition_InternalReason = 5
	// The revision can't be created because it violates an org policy setting.
	Condition_REVISION_ORG_POLICY_VIOLATION Condition_InternalReason = 6
	// Enabling GCFv2 URI support; this is a transient reason.
	Condition_ENABLING_GCFV2_URI_SUPPORT Condition_InternalReason = 7
)

// Enum value maps for Condition_InternalReason.
var (
	Condition_InternalReason_name = map[int32]string{
		0: "INTERNAL_REASON_UNDEFINED",
		1: "CONFLICTING_REVISION_NAME",
		2: "REVISION_MISSING",
		3: "CONFIGURATION_MISSING",
		4: "ASSIGNING_TRAFFIC",
		5: "UPDATING_INGRESS_TRAFFIC_ALLOWED",
		6: "REVISION_ORG_POLICY_VIOLATION",
		7: "ENABLING_GCFV2_URI_SUPPORT",
	}
	Condition_InternalReason_value = map[string]int32{
...
func (x Condition_InternalReason) Enum() *Condition_InternalReason {
	p := new(Condition_InternalReason)
	*p = x
	return p
}

func (x Condition_InternalReason) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (Condition_InternalReason) Descriptor() protoreflect.EnumDescriptor {
	return file_google_cloud_run_v2_condition_proto_enumTypes[3].Descriptor()
}

func (Condition_InternalReason) Type() protoreflect.EnumType {
	return &file_google_cloud_run_v2_condition_proto_enumTypes[3]
}

func (x Condition_InternalReason) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use Condition_InternalReason.Descriptor instead.
func (Condition_InternalReason) EnumDescriptor() ([]byte, []int) {
	return file_google_cloud_run_v2_condition_proto_rawDescGZIP(), []int{0, 3}
}

// Reasons specific to DomainMapping resource.
type Condition_DomainMappingReason int32

const (
	// Default value.
	Condition_DOMAIN_MAPPING_REASON_UNDEFINED Condition_DomainMappingReason = 0
	// Internal route is not yet ready.
	Condition_ROUTE_NOT_READY Condition_DomainMappingReason = 1
	// Insufficient permissions.
	Condition_PERMISSION_DENIED Condition_DomainMappingReason = 2
	// Certificate already exists.
	Condition_CERTIFICATE_ALREADY_EXISTS Condition_DomainMappingReason = 3
	// Mapping already exists.
	Condition_MAPPING_ALREADY_EXISTS Condition_DomainMappingReason = 4
	// Certificate issuance pending.
	Condition_CERTIFICATE_PENDING Condition_DomainMappingReason = 5
	// Certificate issuance failed.
	Condition_CERTIFICATE_FAILED Condition_DomainMappingReason = 6
)

// Enum value maps for Condition_DomainMappingReason.
var (
	Condition_DomainMappingReason_name = map[int32]string{
		0: "DOMAIN_MAPPING_REASON_UNDEFINED",
		1: "ROUTE_NOT_READY",
		2: "PERMISSION_DENIED",
		3: "CERTIFICATE_ALREADY_EXISTS",
		4: "MAPPING_ALREADY_EXISTS",
		5: "CERTIFICATE_PENDING",
		6: "CERTIFICATE_FAILED",
	}
	Condition_DomainMappingReason_value = map[string]int32{
...
func (x Condition_DomainMappingReason) Enum() *Condition_DomainMappingReason {
	p := new(Condition_DomainMappingReason)
	*p = x
	return p
}

func (x Condition_DomainMappingReason) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (Condition_DomainMappingReason) Descriptor() protoreflect.EnumDescriptor {
	return file_google_cloud_run_v2_condition_proto_enumTypes[4].Descriptor()
}

func (Condition_DomainMappingReason) Type() protoreflect.EnumType {
	return &file_google_cloud_run_v2_condition_proto_enumTypes[4]
}

func (x Condition_DomainMappingReason) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use Condition_DomainMappingReason.Descriptor instead.
func (Condition_DomainMappingReason) EnumDescriptor() ([]byte, []int) {
...
func (Condition_RevisionReason) Descriptor() protoreflect.EnumDescriptor {
	return file_google_cloud_run_v2_condition_proto_enumTypes[5].Descriptor()
}

func (Condition_RevisionReason) Type() protoreflect.EnumType {
	return &file_google_cloud_run_v2_condition_proto_enumTypes[5]
}
...
func (Condition_RevisionReason) EnumDescriptor() ([]byte, []int) {
	return file_google_cloud_run_v2_condition_proto_rawDescGZIP(), []int{0, 5}
}
...
func (Condition_ExecutionReason) Descriptor() protoreflect.EnumDescriptor {
	return file_google_cloud_run_v2_condition_proto_enumTypes[6].Descriptor()
}

func (Condition_ExecutionReason) Type() protoreflect.EnumType {
	return &file_google_cloud_run_v2_condition_proto_enumTypes[6]
}
...
func (Condition_ExecutionReason) EnumDescriptor() ([]byte, []int) {
	return file_google_cloud_run_v2_condition_proto_rawDescGZIP(), []int{0, 6}
}
...
type Condition struct {
	...
	//	*Condition_Reason
	//	*Condition_InternalReason_
	//	*Condition_DomainMappingReason_
...
func (x *Condition) GetInternalReason() Condition_InternalReason {
	if x, ok := x.GetReasons().(*Condition_InternalReason_); ok {
		return x.InternalReason
	}
	return Condition_INTERNAL_REASON_UNDEFINED
}

func (x *Condition) GetDomainMappingReason() Condition_DomainMappingReason {
	if x, ok := x.GetReasons().(*Condition_DomainMappingReason_); ok {
		return x.DomainMappingReason
	}
	return Condition_DOMAIN_MAPPING_REASON_UNDEFINED
}
...
type Condition_InternalReason_ struct {
	// A reason for the internal condition.
	InternalReason Condition_InternalReason `protobuf:"varint,7,opt,name=internal_reason,json=internalReason,proto3,enum=google.cloud.run.v2.Condition_InternalReason,oneof"`
}

type Condition_DomainMappingReason_ struct {
	// A reason for the domain mapping condition.
	DomainMappingReason Condition_DomainMappingReason `protobuf:"varint,8,opt,name=domain_mapping_reason,json=domainMappingReason,proto3,enum=google.cloud.run.v2.Condition_DomainMappingReason,oneof"`
}
...
func (*Condition_InternalReason_) isCondition_Reasons() {}

func (*Condition_DomainMappingReason_) isCondition_Reasons() {}
...
var file_google_cloud_run_v2_condition_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xea, 0x11, 0x0a, 0x09,
	...
	,
	...
	0x03, 0x22, 0xce, 0x03, 0x0a, 0x0c, 0x43, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x52, 0x65, 0x61, 0x73,
	0x6f, 0x6e, 0x12, 0x1b, 0x0a, 0x17, 0x43, 0x4f, 0x4d, 0x4d, 0x4f, 0x4e, 0x5f, 0x52, 0x45, 0x41,
	0x53, 0x4f, 0x4e, 0x5f, 0x55, 0x4e, 0x44, 0x45, 0x46, 0x49, 0x4e, 0x45, 0x44, 0x10, 0x00, 0x12,
	0x0b, 0x0a, 0x07, 0x55, 0x4e, 0x4b, 0x4e, 0x4f, 0x57, 0x4e, 0x10, 0x01, 0x12, 0x11, 0x0a, 0x0d,
	0x52, 0x4f, 0x55, 0x54, 0x45, 0x5f, 0x4d, 0x49, 0x53, 0x53, 0x49, 0x4e, 0x47, 0x10, 0x02, 0x12,
	...
	,
...
var file_google_cloud_run_v2_condition_proto_enumTypes = make([]protoimpl.EnumInfo, 7)
...
var file_google_cloud_run_v2_condition_proto_goTypes = []interface{}{
	...
	(Condition_InternalReason)(0),      // 3: google.cloud.run.v2.Condition.InternalReason
	(Condition_DomainMappingReason)(0), // 4: google.cloud.run.v2.Condition.DomainMappingReason
	(Condition_RevisionReason)(0),      // 5: google.cloud.run.v2.Condition.RevisionReason
	(Condition_ExecutionReason)(0),     // 6: google.cloud.run.v2.Condition.ExecutionReason
	(*Condition)(nil),                  // 7: google.cloud.run.v2.Condition
...
var file_google_cloud_run_v2_condition_proto_depIdxs = []int32{
	...
	8, // 1: google.cloud.run.v2.Condition.last_transition_time:type_name -> google.protobuf.Timestamp
	...
	3, // 4: google.cloud.run.v2.Condition.internal_reason:type_name -> google.cloud.run.v2.Condition.InternalReason
	4, // 5: google.cloud.run.v2.Condition.domain_mapping_reason:type_name -> google.cloud.run.v2.Condition.DomainMappingReason
	5, // 6: google.cloud.run.v2.Condition.revision_reason:type_name -> google.cloud.run.v2.Condition.RevisionReason
	6, // 7: google.cloud.run.v2.Condition.execution_reason:type_name -> google.cloud.run.v2.Condition.ExecutionReason
...
func file_google_cloud_run_v2_condition_proto_init() {
	...
	file_google_cloud_run_v2_condition_proto_msgTypes[0].OneofWrappers = []interface{}{
		...
		(*Condition_InternalReason_)(nil),
		(*Condition_DomainMappingReason_)(nil),
