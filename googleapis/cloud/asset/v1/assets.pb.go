...
var file_google_cloud_asset_v1_assets_proto_rawDesc = []byte{
	...
	0x74, 0x72, 0x75, 0x63, 0x74, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x42, 0x98, 0x01, 0x0a, 0x19,
...
var file_google_cloud_asset_v1_assets_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_cloud_asset_v1_assets_proto_goTypes = []interface{}{
	...
	(*v11.Policy)(nil),           // 6: google.cloud.orgpolicy.v1.Policy
	(*v12.AccessPolicy)(nil),     // 7: google.identity.accesscontextmanager.v1.AccessPolicy
	(*v12.AccessLevel)(nil),      // 8: google.identity.accesscontextmanager.v1.AccessLevel
	(*v12.ServicePerimeter)(nil), // 9: google.identity.accesscontextmanager.v1.ServicePerimeter
...
var file_google_cloud_asset_v1_assets_proto_depIdxs = []int32{
	...
	4,  // 2: google.cloud.asset.v1.TimeWindow.start_time:type_name -> google.protobuf.Timestamp
	4,  // 3: google.cloud.asset.v1.TimeWindow.end_time:type_name -> google.protobuf.Timestamp
	3,  // 4: google.cloud.asset.v1.Asset.resource:type_name -> google.cloud.asset.v1.Resource
	5,  // 5: google.cloud.asset.v1.Asset.iam_policy:type_name -> google.iam.v1.Policy
	6,  // 6: google.cloud.asset.v1.Asset.org_policy:type_name -> google.cloud.orgpolicy.v1.Policy
	7,  // 7: google.cloud.asset.v1.Asset.access_policy:type_name -> google.identity.accesscontextmanager.v1.AccessPolicy
	8,  // 8: google.cloud.asset.v1.Asset.access_level:type_name -> google.identity.accesscontextmanager.v1.AccessLevel
	9,  // 9: google.cloud.asset.v1.Asset.service_perimeter:type_name -> google.identity.accesscontextmanager.v1.ServicePerimeter
	10, // 10: google.cloud.asset.v1.Resource.data:type_name -> google.protobuf.Struct
