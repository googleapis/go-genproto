...
func (SessionEntityType_EntityOverrideMode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_session_entity_type_c408f12785d6eb00, []int{0, 0}
}
...
func (*SessionEntityType) Descriptor() ([]byte, []int) {
	return fileDescriptor_session_entity_type_c408f12785d6eb00, []int{0}
}
...
func (*ListSessionEntityTypesRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_session_entity_type_c408f12785d6eb00, []int{1}
}
...
func (*ListSessionEntityTypesResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_session_entity_type_c408f12785d6eb00, []int{2}
}
...
func (*GetSessionEntityTypeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_session_entity_type_c408f12785d6eb00, []int{3}
}
...
func (*CreateSessionEntityTypeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_session_entity_type_c408f12785d6eb00, []int{4}
}
...
func (*UpdateSessionEntityTypeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_session_entity_type_c408f12785d6eb00, []int{5}
}
...
func (*DeleteSessionEntityTypeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_session_entity_type_c408f12785d6eb00, []int{6}
}
...
func init() {
	proto.RegisterFile("google/cloud/dialogflow/v2beta1/session_entity_type.proto", fileDescriptor_session_entity_type_c408f12785d6eb00)
}

var fileDescriptor_session_entity_type_c408f12785d6eb00 = []byte{
