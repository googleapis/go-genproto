...
func (CloudFunctionStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_functions_86e4424260a7e456, []int{0}
}
...
func (*HTTPSTrigger) Descriptor() ([]byte, []int) {
	return fileDescriptor_functions_86e4424260a7e456, []int{1}
}
...
func (*EventTrigger) Descriptor() ([]byte, []int) {
	return fileDescriptor_functions_86e4424260a7e456, []int{2}
}
...
func (*SourceRepository) Descriptor() ([]byte, []int) {
	return fileDescriptor_functions_86e4424260a7e456, []int{3}
}
...
func (*CreateFunctionRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_functions_86e4424260a7e456, []int{4}
}
...
func (*UpdateFunctionRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_functions_86e4424260a7e456, []int{5}
}
...
func (*GetFunctionRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_functions_86e4424260a7e456, []int{6}
}
...
func (*ListFunctionsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_functions_86e4424260a7e456, []int{7}
}
...
func (*ListFunctionsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_functions_86e4424260a7e456, []int{8}
}
...
func (*DeleteFunctionRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_functions_86e4424260a7e456, []int{9}
}
...
func (*CallFunctionRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_functions_86e4424260a7e456, []int{10}
}
...
func (*CallFunctionResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_functions_86e4424260a7e456, []int{11}
}
...
func init() {
	proto.RegisterFile("google/cloud/functions/v1beta2/functions.proto", fileDescriptor_functions_86e4424260a7e456)
}

var fileDescriptor_functions_86e4424260a7e456 = []byte{
