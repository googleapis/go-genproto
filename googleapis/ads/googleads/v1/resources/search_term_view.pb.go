...
func (x *SearchTermView) Reset() {
	*x = SearchTermView{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v1_resources_search_term_view_proto_msgTypes[0]
...
func (*SearchTermView) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v1_resources_search_term_view_proto_rawDescGZIP(), []int{0}
}
...
var file_google_ads_googleads_v1_resources_search_term_view_proto_rawDesc = []byte{
	...
	0x2e, 0x76, 0x31, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x1a, 0x40, 0x67,
	0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2f, 0x61, 0x64, 0x73, 0x2f, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65,
	0x61, 0x64, 0x73, 0x2f, 0x76, 0x31, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x73, 0x65, 0x61,
	...
	0x6c, 0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73,
	0x2e, 0x76, 0x31, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68,
...
var (
	file_google_ads_googleads_v1_resources_search_term_view_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v1_resources_search_term_view_proto_rawDescData = file_google_ads_googleads_v1_resources_search_term_view_proto_rawDesc
)

func file_google_ads_googleads_v1_resources_search_term_view_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v1_resources_search_term_view_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v1_resources_search_term_view_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v1_resources_search_term_view_proto_rawDescData)
	})
	return file_google_ads_googleads_v1_resources_search_term_view_proto_rawDescData
}

var file_google_ads_googleads_v1_resources_search_term_view_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v1_resources_search_term_view_proto_goTypes = []interface{}{
	(*SearchTermView)(nil),       // 0: google.ads.googleads.v1.resources.SearchTermView
	(*wrappers.StringValue)(nil), // 1: google.protobuf.StringValue
	(enums.SearchTermTargetingStatusEnum_SearchTermTargetingStatus)(0), // 2: google.ads.googleads.v1.enums.SearchTermTargetingStatusEnum.SearchTermTargetingStatus
}
var file_google_ads_googleads_v1_resources_search_term_view_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v1.resources.SearchTermView.search_term:type_name -> google.protobuf.StringValue
	1, // 1: google.ads.googleads.v1.resources.SearchTermView.ad_group:type_name -> google.protobuf.StringValue
	2, // 2: google.ads.googleads.v1.resources.SearchTermView.status:type_name -> google.ads.googleads.v1.enums.SearchTermTargetingStatusEnum.SearchTermTargetingStatus
...
func init() { file_google_ads_googleads_v1_resources_search_term_view_proto_init() }
func file_google_ads_googleads_v1_resources_search_term_view_proto_init() {
	if File_google_ads_googleads_v1_resources_search_term_view_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v1_resources_search_term_view_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v1_resources_search_term_view_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v1_resources_search_term_view_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v1_resources_search_term_view_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v1_resources_search_term_view_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v1_resources_search_term_view_proto = out.File
	file_google_ads_googleads_v1_resources_search_term_view_proto_rawDesc = nil
	file_google_ads_googleads_v1_resources_search_term_view_proto_goTypes = nil
	file_google_ads_googleads_v1_resources_search_term_view_proto_depIdxs = nil
}
