...
func (FeedAttributeOperation_Operator) Descriptor() protoreflect.EnumDescriptor {
	return file_google_ads_googleads_v1_resources_feed_proto_enumTypes[0].Descriptor()
}

func (FeedAttributeOperation_Operator) Type() protoreflect.EnumType {
	return &file_google_ads_googleads_v1_resources_feed_proto_enumTypes[0]
}
...
func (FeedAttributeOperation_Operator) EnumDescriptor() ([]byte, []int) {
	return file_google_ads_googleads_v1_resources_feed_proto_rawDescGZIP(), []int{2, 0}
}
...
func (x *Feed) Reset() {
	*x = Feed{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v1_resources_feed_proto_msgTypes[0]
...
func (*Feed) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v1_resources_feed_proto_rawDescGZIP(), []int{0}
}
...
func (x *FeedAttribute) Reset() {
	*x = FeedAttribute{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v1_resources_feed_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*FeedAttribute) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v1_resources_feed_proto_rawDescGZIP(), []int{1}
}
...
func (x *FeedAttributeOperation) Reset() {
	*x = FeedAttributeOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v1_resources_feed_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*FeedAttributeOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v1_resources_feed_proto_rawDescGZIP(), []int{2}
}
...
func (x *Feed_PlacesLocationFeedData) Reset() {
	*x = Feed_PlacesLocationFeedData{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v1_resources_feed_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Feed_PlacesLocationFeedData) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v1_resources_feed_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *Feed_AffiliateLocationFeedData) Reset() {
	*x = Feed_AffiliateLocationFeedData{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v1_resources_feed_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Feed_AffiliateLocationFeedData) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v1_resources_feed_proto_rawDescGZIP(), []int{0, 1}
}
...
func (x *Feed_PlacesLocationFeedData_OAuthInfo) Reset() {
	*x = Feed_PlacesLocationFeedData_OAuthInfo{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v1_resources_feed_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Feed_PlacesLocationFeedData_OAuthInfo) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v1_resources_feed_proto_rawDescGZIP(), []int{0, 0, 0}
}
...
var file_google_ads_googleads_v1_resources_feed_proto_rawDesc = []byte{
	...
	0x76, 0x31, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x66, 0x65, 0x65, 0x64, 0x5f, 0x6f, 0x72,
	0x69, 0x67, 0x69, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x2f, 0x67, 0x6f, 0x6f, 0x67,
	0x6c, 0x65, 0x2f, 0x61, 0x64, 0x73, 0x2f, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73,
	0x2f, 0x76, 0x31, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x66, 0x65, 0x65, 0x64, 0x5f, 0x73,
	...
	0x73, 0x2e, 0x76, 0x31, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x46, 0x65, 0x65, 0x64, 0x53,
	...
	0x6c, 0x65, 0x61, 0x64, 0x73, 0x2e, 0x76, 0x31, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x41,
	0x66, 0x66, 0x69, 0x6c, 0x69, 0x61, 0x74, 0x65, 0x4c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	...
	0x67, 0x6c, 0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64,
	0x73, 0x2e, 0x76, 0x31, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x42, 0x09,
...
var (
	file_google_ads_googleads_v1_resources_feed_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v1_resources_feed_proto_rawDescData = file_google_ads_googleads_v1_resources_feed_proto_rawDesc
)

func file_google_ads_googleads_v1_resources_feed_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v1_resources_feed_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v1_resources_feed_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v1_resources_feed_proto_rawDescData)
	})
	return file_google_ads_googleads_v1_resources_feed_proto_rawDescData
}

var file_google_ads_googleads_v1_resources_feed_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_google_ads_googleads_v1_resources_feed_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_google_ads_googleads_v1_resources_feed_proto_goTypes = []interface{}{
	(FeedAttributeOperation_Operator)(0),               // 0: google.ads.googleads.v1.resources.FeedAttributeOperation.Operator
	(*Feed)(nil),                                       // 1: google.ads.googleads.v1.resources.Feed
	(*FeedAttribute)(nil),                              // 2: google.ads.googleads.v1.resources.FeedAttribute
	(*FeedAttributeOperation)(nil),                     // 3: google.ads.googleads.v1.resources.FeedAttributeOperation
	(*Feed_PlacesLocationFeedData)(nil),                // 4: google.ads.googleads.v1.resources.Feed.PlacesLocationFeedData
	(*Feed_AffiliateLocationFeedData)(nil),             // 5: google.ads.googleads.v1.resources.Feed.AffiliateLocationFeedData
	(*Feed_PlacesLocationFeedData_OAuthInfo)(nil),      // 6: google.ads.googleads.v1.resources.Feed.PlacesLocationFeedData.OAuthInfo
	(*wrappers.Int64Value)(nil),                        // 7: google.protobuf.Int64Value
	(*wrappers.StringValue)(nil),                       // 8: google.protobuf.StringValue
	(enums.FeedOriginEnum_FeedOrigin)(0),               // 9: google.ads.googleads.v1.enums.FeedOriginEnum.FeedOrigin
	(enums.FeedStatusEnum_FeedStatus)(0),               // 10: google.ads.googleads.v1.enums.FeedStatusEnum.FeedStatus
	(enums.FeedAttributeTypeEnum_FeedAttributeType)(0), // 11: google.ads.googleads.v1.enums.FeedAttributeTypeEnum.FeedAttributeType
	(*wrappers.BoolValue)(nil),                         // 12: google.protobuf.BoolValue
	(enums.AffiliateLocationFeedRelationshipTypeEnum_AffiliateLocationFeedRelationshipType)(0), // 13: google.ads.googleads.v1.enums.AffiliateLocationFeedRelationshipTypeEnum.AffiliateLocationFeedRelationshipType
}
var file_google_ads_googleads_v1_resources_feed_proto_depIdxs = []int32{
	7,  // 0: google.ads.googleads.v1.resources.Feed.id:type_name -> google.protobuf.Int64Value
	8,  // 1: google.ads.googleads.v1.resources.Feed.name:type_name -> google.protobuf.StringValue
	2,  // 2: google.ads.googleads.v1.resources.Feed.attributes:type_name -> google.ads.googleads.v1.resources.FeedAttribute
	3,  // 3: google.ads.googleads.v1.resources.Feed.attribute_operations:type_name -> google.ads.googleads.v1.resources.FeedAttributeOperation
	9,  // 4: google.ads.googleads.v1.resources.Feed.origin:type_name -> google.ads.googleads.v1.enums.FeedOriginEnum.FeedOrigin
	10, // 5: google.ads.googleads.v1.resources.Feed.status:type_name -> google.ads.googleads.v1.enums.FeedStatusEnum.FeedStatus
	4,  // 6: google.ads.googleads.v1.resources.Feed.places_location_feed_data:type_name -> google.ads.googleads.v1.resources.Feed.PlacesLocationFeedData
	5,  // 7: google.ads.googleads.v1.resources.Feed.affiliate_location_feed_data:type_name -> google.ads.googleads.v1.resources.Feed.AffiliateLocationFeedData
	7,  // 8: google.ads.googleads.v1.resources.FeedAttribute.id:type_name -> google.protobuf.Int64Value
	8,  // 9: google.ads.googleads.v1.resources.FeedAttribute.name:type_name -> google.protobuf.StringValue
	11, // 10: google.ads.googleads.v1.resources.FeedAttribute.type:type_name -> google.ads.googleads.v1.enums.FeedAttributeTypeEnum.FeedAttributeType
	12, // 11: google.ads.googleads.v1.resources.FeedAttribute.is_part_of_key:type_name -> google.protobuf.BoolValue
	0,  // 12: google.ads.googleads.v1.resources.FeedAttributeOperation.operator:type_name -> google.ads.googleads.v1.resources.FeedAttributeOperation.Operator
	2,  // 13: google.ads.googleads.v1.resources.FeedAttributeOperation.value:type_name -> google.ads.googleads.v1.resources.FeedAttribute
	6,  // 14: google.ads.googleads.v1.resources.Feed.PlacesLocationFeedData.oauth_info:type_name -> google.ads.googleads.v1.resources.Feed.PlacesLocationFeedData.OAuthInfo
	8,  // 15: google.ads.googleads.v1.resources.Feed.PlacesLocationFeedData.email_address:type_name -> google.protobuf.StringValue
	8,  // 16: google.ads.googleads.v1.resources.Feed.PlacesLocationFeedData.business_account_id:type_name -> google.protobuf.StringValue
	8,  // 17: google.ads.googleads.v1.resources.Feed.PlacesLocationFeedData.business_name_filter:type_name -> google.protobuf.StringValue
	8,  // 18: google.ads.googleads.v1.resources.Feed.PlacesLocationFeedData.category_filters:type_name -> google.protobuf.StringValue
	8,  // 19: google.ads.googleads.v1.resources.Feed.PlacesLocationFeedData.label_filters:type_name -> google.protobuf.StringValue
	7,  // 20: google.ads.googleads.v1.resources.Feed.AffiliateLocationFeedData.chain_ids:type_name -> google.protobuf.Int64Value
	13, // 21: google.ads.googleads.v1.resources.Feed.AffiliateLocationFeedData.relationship_type:type_name -> google.ads.googleads.v1.enums.AffiliateLocationFeedRelationshipTypeEnum.AffiliateLocationFeedRelationshipType
	8,  // 22: google.ads.googleads.v1.resources.Feed.PlacesLocationFeedData.OAuthInfo.http_method:type_name -> google.protobuf.StringValue
	8,  // 23: google.ads.googleads.v1.resources.Feed.PlacesLocationFeedData.OAuthInfo.http_request_url:type_name -> google.protobuf.StringValue
	8,  // 24: google.ads.googleads.v1.resources.Feed.PlacesLocationFeedData.OAuthInfo.http_authorization_header:type_name -> google.protobuf.StringValue
...
func init() { file_google_ads_googleads_v1_resources_feed_proto_init() }
func file_google_ads_googleads_v1_resources_feed_proto_init() {
	if File_google_ads_googleads_v1_resources_feed_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v1_resources_feed_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Feed); i {
			case 0:
				return &v.state
			case 1:
		...
		file_google_ads_googleads_v1_resources_feed_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v1_resources_feed_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v1_resources_feed_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v1_resources_feed_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v1_resources_feed_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v1_resources_feed_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v1_resources_feed_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v1_resources_feed_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v1_resources_feed_proto_depIdxs,
		EnumInfos:         file_google_ads_googleads_v1_resources_feed_proto_enumTypes,
		MessageInfos:      file_google_ads_googleads_v1_resources_feed_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v1_resources_feed_proto = out.File
	file_google_ads_googleads_v1_resources_feed_proto_rawDesc = nil
	file_google_ads_googleads_v1_resources_feed_proto_goTypes = nil
	file_google_ads_googleads_v1_resources_feed_proto_depIdxs = nil
}
