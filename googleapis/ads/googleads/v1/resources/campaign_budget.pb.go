...
func (*CampaignBudget) Descriptor() ([]byte, []int) {
	return fileDescriptor_campaign_budget_bd7a09e6a2a225dc, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v1/resources/campaign_budget.proto", fileDescriptor_campaign_budget_bd7a09e6a2a225dc)
}

var fileDescriptor_campaign_budget_bd7a09e6a2a225dc = []byte{
