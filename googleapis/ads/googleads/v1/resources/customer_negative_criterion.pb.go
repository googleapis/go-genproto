...
func (x *CustomerNegativeCriterion) Reset() {
	*x = CustomerNegativeCriterion{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v1_resources_customer_negative_criterion_proto_msgTypes[0]
...
func (*CustomerNegativeCriterion) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v1_resources_customer_negative_criterion_proto_rawDescGZIP(), []int{0}
}
...
var file_google_ads_googleads_v1_resources_customer_negative_criterion_proto_rawDesc = []byte{
	...
	0x31, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2f, 0x63, 0x72, 0x69, 0x74, 0x65, 0x72, 0x69,
	...
	0x2e, 0x76, 0x31, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x4d, 0x6f, 0x62, 0x69, 0x6c,
	...
	0x64, 0x73, 0x2e, 0x76, 0x31, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x50, 0x6c, 0x61,
	...
	0x6c, 0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73,
	0x2e, 0x76, 0x31, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x42, 0x1e, 0x43,
...
var (
	file_google_ads_googleads_v1_resources_customer_negative_criterion_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v1_resources_customer_negative_criterion_proto_rawDescData = file_google_ads_googleads_v1_resources_customer_negative_criterion_proto_rawDesc
)

func file_google_ads_googleads_v1_resources_customer_negative_criterion_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v1_resources_customer_negative_criterion_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v1_resources_customer_negative_criterion_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v1_resources_customer_negative_criterion_proto_rawDescData)
	})
	return file_google_ads_googleads_v1_resources_customer_negative_criterion_proto_rawDescData
}

var file_google_ads_googleads_v1_resources_customer_negative_criterion_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v1_resources_customer_negative_criterion_proto_goTypes = []interface{}{
	(*CustomerNegativeCriterion)(nil),          // 0: google.ads.googleads.v1.resources.CustomerNegativeCriterion
	(*wrappers.Int64Value)(nil),                // 1: google.protobuf.Int64Value
	(enums.CriterionTypeEnum_CriterionType)(0), // 2: google.ads.googleads.v1.enums.CriterionTypeEnum.CriterionType
	(*common.ContentLabelInfo)(nil),            // 3: google.ads.googleads.v1.common.ContentLabelInfo
	(*common.MobileApplicationInfo)(nil),       // 4: google.ads.googleads.v1.common.MobileApplicationInfo
	(*common.MobileAppCategoryInfo)(nil),       // 5: google.ads.googleads.v1.common.MobileAppCategoryInfo
	(*common.PlacementInfo)(nil),               // 6: google.ads.googleads.v1.common.PlacementInfo
	(*common.YouTubeVideoInfo)(nil),            // 7: google.ads.googleads.v1.common.YouTubeVideoInfo
	(*common.YouTubeChannelInfo)(nil),          // 8: google.ads.googleads.v1.common.YouTubeChannelInfo
}
var file_google_ads_googleads_v1_resources_customer_negative_criterion_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v1.resources.CustomerNegativeCriterion.id:type_name -> google.protobuf.Int64Value
	2, // 1: google.ads.googleads.v1.resources.CustomerNegativeCriterion.type:type_name -> google.ads.googleads.v1.enums.CriterionTypeEnum.CriterionType
	3, // 2: google.ads.googleads.v1.resources.CustomerNegativeCriterion.content_label:type_name -> google.ads.googleads.v1.common.ContentLabelInfo
	4, // 3: google.ads.googleads.v1.resources.CustomerNegativeCriterion.mobile_application:type_name -> google.ads.googleads.v1.common.MobileApplicationInfo
	5, // 4: google.ads.googleads.v1.resources.CustomerNegativeCriterion.mobile_app_category:type_name -> google.ads.googleads.v1.common.MobileAppCategoryInfo
	6, // 5: google.ads.googleads.v1.resources.CustomerNegativeCriterion.placement:type_name -> google.ads.googleads.v1.common.PlacementInfo
	7, // 6: google.ads.googleads.v1.resources.CustomerNegativeCriterion.youtube_video:type_name -> google.ads.googleads.v1.common.YouTubeVideoInfo
	8, // 7: google.ads.googleads.v1.resources.CustomerNegativeCriterion.youtube_channel:type_name -> google.ads.googleads.v1.common.YouTubeChannelInfo
...
func init() { file_google_ads_googleads_v1_resources_customer_negative_criterion_proto_init() }
func file_google_ads_googleads_v1_resources_customer_negative_criterion_proto_init() {
	if File_google_ads_googleads_v1_resources_customer_negative_criterion_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v1_resources_customer_negative_criterion_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v1_resources_customer_negative_criterion_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v1_resources_customer_negative_criterion_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v1_resources_customer_negative_criterion_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v1_resources_customer_negative_criterion_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v1_resources_customer_negative_criterion_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v1_resources_customer_negative_criterion_proto = out.File
	file_google_ads_googleads_v1_resources_customer_negative_criterion_proto_rawDesc = nil
	file_google_ads_googleads_v1_resources_customer_negative_criterion_proto_goTypes = nil
	file_google_ads_googleads_v1_resources_customer_negative_criterion_proto_depIdxs = nil
}
