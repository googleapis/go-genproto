...
func (*AdParameter) Descriptor() ([]byte, []int) {
	return fileDescriptor_ad_parameter_0da2acb6a4b9fe4e, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v1/resources/ad_parameter.proto", fileDescriptor_ad_parameter_0da2acb6a4b9fe4e)
}

var fileDescriptor_ad_parameter_0da2acb6a4b9fe4e = []byte{
