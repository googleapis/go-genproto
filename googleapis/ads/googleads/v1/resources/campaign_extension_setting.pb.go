...
func (x *CampaignExtensionSetting) Reset() {
	*x = CampaignExtensionSetting{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v1_resources_campaign_extension_setting_proto_msgTypes[0]
...
func (*CampaignExtensionSetting) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v1_resources_campaign_extension_setting_proto_rawDescGZIP(), []int{0}
}
...
var file_google_ads_googleads_v1_resources_campaign_extension_setting_proto_rawDesc = []byte{
	...
	0x2e, 0x76, 0x31, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x42, 0x1d, 0x43,
...
var (
	file_google_ads_googleads_v1_resources_campaign_extension_setting_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v1_resources_campaign_extension_setting_proto_rawDescData = file_google_ads_googleads_v1_resources_campaign_extension_setting_proto_rawDesc
)

func file_google_ads_googleads_v1_resources_campaign_extension_setting_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v1_resources_campaign_extension_setting_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v1_resources_campaign_extension_setting_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v1_resources_campaign_extension_setting_proto_rawDescData)
	})
	return file_google_ads_googleads_v1_resources_campaign_extension_setting_proto_rawDescData
}

var file_google_ads_googleads_v1_resources_campaign_extension_setting_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v1_resources_campaign_extension_setting_proto_goTypes = []interface{}{
	(*CampaignExtensionSetting)(nil),                             // 0: google.ads.googleads.v1.resources.CampaignExtensionSetting
...
var file_google_ads_googleads_v1_resources_campaign_extension_setting_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v1.resources.CampaignExtensionSetting.extension_type:type_name -> google.ads.googleads.v1.enums.ExtensionTypeEnum.ExtensionType
	2, // 1: google.ads.googleads.v1.resources.CampaignExtensionSetting.campaign:type_name -> google.protobuf.StringValue
	2, // 2: google.ads.googleads.v1.resources.CampaignExtensionSetting.extension_feed_items:type_name -> google.protobuf.StringValue
	3, // 3: google.ads.googleads.v1.resources.CampaignExtensionSetting.device:type_name -> google.ads.googleads.v1.enums.ExtensionSettingDeviceEnum.ExtensionSettingDevice
...
func init() { file_google_ads_googleads_v1_resources_campaign_extension_setting_proto_init() }
func file_google_ads_googleads_v1_resources_campaign_extension_setting_proto_init() {
	if File_google_ads_googleads_v1_resources_campaign_extension_setting_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v1_resources_campaign_extension_setting_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v1_resources_campaign_extension_setting_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v1_resources_campaign_extension_setting_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v1_resources_campaign_extension_setting_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v1_resources_campaign_extension_setting_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v1_resources_campaign_extension_setting_proto = out.File
	file_google_ads_googleads_v1_resources_campaign_extension_setting_proto_rawDesc = nil
	file_google_ads_googleads_v1_resources_campaign_extension_setting_proto_goTypes = nil
	file_google_ads_googleads_v1_resources_campaign_extension_setting_proto_depIdxs = nil
}
