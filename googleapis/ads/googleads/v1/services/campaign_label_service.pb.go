...
func (x *GetCampaignLabelRequest) Reset() {
	*x = GetCampaignLabelRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v1_services_campaign_label_service_proto_msgTypes[0]
...
func (*GetCampaignLabelRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v1_services_campaign_label_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *MutateCampaignLabelsRequest) Reset() {
	*x = MutateCampaignLabelsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v1_services_campaign_label_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCampaignLabelsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v1_services_campaign_label_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *CampaignLabelOperation) Reset() {
	*x = CampaignLabelOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v1_services_campaign_label_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CampaignLabelOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v1_services_campaign_label_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateCampaignLabelsResponse) Reset() {
	*x = MutateCampaignLabelsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v1_services_campaign_label_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCampaignLabelsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v1_services_campaign_label_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *MutateCampaignLabelResult) Reset() {
	*x = MutateCampaignLabelResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v1_services_campaign_label_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCampaignLabelResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v1_services_campaign_label_service_proto_rawDescGZIP(), []int{4}
}
...
var File_google_ads_googleads_v1_services_campaign_label_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v1_services_campaign_label_service_proto_rawDesc = []byte{
...
var (
	file_google_ads_googleads_v1_services_campaign_label_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v1_services_campaign_label_service_proto_rawDescData = file_google_ads_googleads_v1_services_campaign_label_service_proto_rawDesc
)

func file_google_ads_googleads_v1_services_campaign_label_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v1_services_campaign_label_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v1_services_campaign_label_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v1_services_campaign_label_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v1_services_campaign_label_service_proto_rawDescData
}

var file_google_ads_googleads_v1_services_campaign_label_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_google_ads_googleads_v1_services_campaign_label_service_proto_goTypes = []interface{}{
	(*GetCampaignLabelRequest)(nil),      // 0: google.ads.googleads.v1.services.GetCampaignLabelRequest
	(*MutateCampaignLabelsRequest)(nil),  // 1: google.ads.googleads.v1.services.MutateCampaignLabelsRequest
	(*CampaignLabelOperation)(nil),       // 2: google.ads.googleads.v1.services.CampaignLabelOperation
	(*MutateCampaignLabelsResponse)(nil), // 3: google.ads.googleads.v1.services.MutateCampaignLabelsResponse
	(*MutateCampaignLabelResult)(nil),    // 4: google.ads.googleads.v1.services.MutateCampaignLabelResult
	(*resources.CampaignLabel)(nil),      // 5: google.ads.googleads.v1.resources.CampaignLabel
	(*status.Status)(nil),                // 6: google.rpc.Status
}
var file_google_ads_googleads_v1_services_campaign_label_service_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v1.services.MutateCampaignLabelsRequest.operations:type_name -> google.ads.googleads.v1.services.CampaignLabelOperation
	5, // 1: google.ads.googleads.v1.services.CampaignLabelOperation.create:type_name -> google.ads.googleads.v1.resources.CampaignLabel
	6, // 2: google.ads.googleads.v1.services.MutateCampaignLabelsResponse.partial_failure_error:type_name -> google.rpc.Status
	4, // 3: google.ads.googleads.v1.services.MutateCampaignLabelsResponse.results:type_name -> google.ads.googleads.v1.services.MutateCampaignLabelResult
	0, // 4: google.ads.googleads.v1.services.CampaignLabelService.GetCampaignLabel:input_type -> google.ads.googleads.v1.services.GetCampaignLabelRequest
	1, // 5: google.ads.googleads.v1.services.CampaignLabelService.MutateCampaignLabels:input_type -> google.ads.googleads.v1.services.MutateCampaignLabelsRequest
	5, // 6: google.ads.googleads.v1.services.CampaignLabelService.GetCampaignLabel:output_type -> google.ads.googleads.v1.resources.CampaignLabel
	3, // 7: google.ads.googleads.v1.services.CampaignLabelService.MutateCampaignLabels:output_type -> google.ads.googleads.v1.services.MutateCampaignLabelsResponse
...
func init() { file_google_ads_googleads_v1_services_campaign_label_service_proto_init() }
func file_google_ads_googleads_v1_services_campaign_label_service_proto_init() {
	if File_google_ads_googleads_v1_services_campaign_label_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v1_services_campaign_label_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v1_services_campaign_label_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v1_services_campaign_label_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v1_services_campaign_label_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v1_services_campaign_label_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v1_services_campaign_label_service_proto_msgTypes[2].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v1_services_campaign_label_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v1_services_campaign_label_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v1_services_campaign_label_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v1_services_campaign_label_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v1_services_campaign_label_service_proto = out.File
	file_google_ads_googleads_v1_services_campaign_label_service_proto_rawDesc = nil
	file_google_ads_googleads_v1_services_campaign_label_service_proto_goTypes = nil
	file_google_ads_googleads_v1_services_campaign_label_service_proto_depIdxs = nil
}
