...
func (x *GetHotelPerformanceViewRequest) Reset() {
	*x = GetHotelPerformanceViewRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v1_services_hotel_performance_view_service_proto_msgTypes[0]
...
func (*GetHotelPerformanceViewRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v1_services_hotel_performance_view_service_proto_rawDescGZIP(), []int{0}
}
...
var File_google_ads_googleads_v1_services_hotel_performance_view_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v1_services_hotel_performance_view_service_proto_rawDesc = []byte{
	...
	0x76, 0x31, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2e, 0x48, 0x6f, 0x74,
	0x65, 0x6c, 0x50, 0x65, 0x72, 0x66, 0x6f, 0x72, 0x6d, 0x61, 0x6e, 0x63, 0x65, 0x56, 0x69, 0x65,
	0x77, 0x22, 0x4c, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x36, 0x12, 0x34, 0x2f, 0x76, 0x31, 0x2f, 0x7b,
...
var (
	file_google_ads_googleads_v1_services_hotel_performance_view_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v1_services_hotel_performance_view_service_proto_rawDescData = file_google_ads_googleads_v1_services_hotel_performance_view_service_proto_rawDesc
)

func file_google_ads_googleads_v1_services_hotel_performance_view_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v1_services_hotel_performance_view_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v1_services_hotel_performance_view_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v1_services_hotel_performance_view_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v1_services_hotel_performance_view_service_proto_rawDescData
}

var file_google_ads_googleads_v1_services_hotel_performance_view_service_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v1_services_hotel_performance_view_service_proto_goTypes = []interface{}{
	(*GetHotelPerformanceViewRequest)(nil), // 0: google.ads.googleads.v1.services.GetHotelPerformanceViewRequest
	(*resources.HotelPerformanceView)(nil), // 1: google.ads.googleads.v1.resources.HotelPerformanceView
}
var file_google_ads_googleads_v1_services_hotel_performance_view_service_proto_depIdxs = []int32{
	0, // 0: google.ads.googleads.v1.services.HotelPerformanceViewService.GetHotelPerformanceView:input_type -> google.ads.googleads.v1.services.GetHotelPerformanceViewRequest
	1, // 1: google.ads.googleads.v1.services.HotelPerformanceViewService.GetHotelPerformanceView:output_type -> google.ads.googleads.v1.resources.HotelPerformanceView
...
func init() { file_google_ads_googleads_v1_services_hotel_performance_view_service_proto_init() }
func file_google_ads_googleads_v1_services_hotel_performance_view_service_proto_init() {
	if File_google_ads_googleads_v1_services_hotel_performance_view_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v1_services_hotel_performance_view_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v1_services_hotel_performance_view_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v1_services_hotel_performance_view_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v1_services_hotel_performance_view_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v1_services_hotel_performance_view_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v1_services_hotel_performance_view_service_proto = out.File
	file_google_ads_googleads_v1_services_hotel_performance_view_service_proto_rawDesc = nil
	file_google_ads_googleads_v1_services_hotel_performance_view_service_proto_goTypes = nil
	file_google_ads_googleads_v1_services_hotel_performance_view_service_proto_depIdxs = nil
}
