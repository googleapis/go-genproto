...
func (x *GetAssetRequest) Reset() {
	*x = GetAssetRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v1_services_asset_service_proto_msgTypes[0]
...
func (*GetAssetRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v1_services_asset_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *MutateAssetsRequest) Reset() {
	*x = MutateAssetsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v1_services_asset_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAssetsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v1_services_asset_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *AssetOperation) Reset() {
	*x = AssetOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v1_services_asset_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AssetOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v1_services_asset_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateAssetsResponse) Reset() {
	*x = MutateAssetsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v1_services_asset_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAssetsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v1_services_asset_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *MutateAssetResult) Reset() {
	*x = MutateAssetResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v1_services_asset_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateAssetResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v1_services_asset_service_proto_rawDescGZIP(), []int{4}
}
...
var File_google_ads_googleads_v1_services_asset_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v1_services_asset_service_proto_rawDesc = []byte{
	...
	0x22, 0x4f, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x30, 0x22, 0x2b, 0x2f, 0x76, 0x31, 0x2f, 0x63, 0x75,
...
var (
	file_google_ads_googleads_v1_services_asset_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v1_services_asset_service_proto_rawDescData = file_google_ads_googleads_v1_services_asset_service_proto_rawDesc
)

func file_google_ads_googleads_v1_services_asset_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v1_services_asset_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v1_services_asset_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v1_services_asset_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v1_services_asset_service_proto_rawDescData
}

var file_google_ads_googleads_v1_services_asset_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_google_ads_googleads_v1_services_asset_service_proto_goTypes = []interface{}{
	(*GetAssetRequest)(nil),      // 0: google.ads.googleads.v1.services.GetAssetRequest
	(*MutateAssetsRequest)(nil),  // 1: google.ads.googleads.v1.services.MutateAssetsRequest
	(*AssetOperation)(nil),       // 2: google.ads.googleads.v1.services.AssetOperation
	(*MutateAssetsResponse)(nil), // 3: google.ads.googleads.v1.services.MutateAssetsResponse
	(*MutateAssetResult)(nil),    // 4: google.ads.googleads.v1.services.MutateAssetResult
	(*resources.Asset)(nil),      // 5: google.ads.googleads.v1.resources.Asset
}
var file_google_ads_googleads_v1_services_asset_service_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v1.services.MutateAssetsRequest.operations:type_name -> google.ads.googleads.v1.services.AssetOperation
	5, // 1: google.ads.googleads.v1.services.AssetOperation.create:type_name -> google.ads.googleads.v1.resources.Asset
	4, // 2: google.ads.googleads.v1.services.MutateAssetsResponse.results:type_name -> google.ads.googleads.v1.services.MutateAssetResult
	0, // 3: google.ads.googleads.v1.services.AssetService.GetAsset:input_type -> google.ads.googleads.v1.services.GetAssetRequest
	1, // 4: google.ads.googleads.v1.services.AssetService.MutateAssets:input_type -> google.ads.googleads.v1.services.MutateAssetsRequest
	5, // 5: google.ads.googleads.v1.services.AssetService.GetAsset:output_type -> google.ads.googleads.v1.resources.Asset
	3, // 6: google.ads.googleads.v1.services.AssetService.MutateAssets:output_type -> google.ads.googleads.v1.services.MutateAssetsResponse
...
func init() { file_google_ads_googleads_v1_services_asset_service_proto_init() }
func file_google_ads_googleads_v1_services_asset_service_proto_init() {
	if File_google_ads_googleads_v1_services_asset_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v1_services_asset_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v1_services_asset_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v1_services_asset_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v1_services_asset_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v1_services_asset_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v1_services_asset_service_proto_msgTypes[2].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v1_services_asset_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v1_services_asset_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v1_services_asset_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v1_services_asset_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v1_services_asset_service_proto = out.File
	file_google_ads_googleads_v1_services_asset_service_proto_rawDesc = nil
	file_google_ads_googleads_v1_services_asset_service_proto_goTypes = nil
	file_google_ads_googleads_v1_services_asset_service_proto_depIdxs = nil
}
