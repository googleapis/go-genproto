...
func (x *GetKeywordPlanCampaignRequest) Reset() {
	*x = GetKeywordPlanCampaignRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v1_services_keyword_plan_campaign_service_proto_msgTypes[0]
...
func (*GetKeywordPlanCampaignRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v1_services_keyword_plan_campaign_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *MutateKeywordPlanCampaignsRequest) Reset() {
	*x = MutateKeywordPlanCampaignsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v1_services_keyword_plan_campaign_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateKeywordPlanCampaignsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v1_services_keyword_plan_campaign_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *KeywordPlanCampaignOperation) Reset() {
	*x = KeywordPlanCampaignOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v1_services_keyword_plan_campaign_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*KeywordPlanCampaignOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v1_services_keyword_plan_campaign_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateKeywordPlanCampaignsResponse) Reset() {
	*x = MutateKeywordPlanCampaignsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v1_services_keyword_plan_campaign_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateKeywordPlanCampaignsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v1_services_keyword_plan_campaign_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *MutateKeywordPlanCampaignResult) Reset() {
	*x = MutateKeywordPlanCampaignResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v1_services_keyword_plan_campaign_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateKeywordPlanCampaignResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v1_services_keyword_plan_campaign_service_proto_rawDescGZIP(), []int{4}
}
...
var File_google_ads_googleads_v1_services_keyword_plan_campaign_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v1_services_keyword_plan_campaign_service_proto_rawDesc = []byte{
	...
	0x31, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x47, 0x65, 0x74, 0x4b, 0x65,
...
var (
	file_google_ads_googleads_v1_services_keyword_plan_campaign_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v1_services_keyword_plan_campaign_service_proto_rawDescData = file_google_ads_googleads_v1_services_keyword_plan_campaign_service_proto_rawDesc
)

func file_google_ads_googleads_v1_services_keyword_plan_campaign_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v1_services_keyword_plan_campaign_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v1_services_keyword_plan_campaign_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v1_services_keyword_plan_campaign_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v1_services_keyword_plan_campaign_service_proto_rawDescData
}

var file_google_ads_googleads_v1_services_keyword_plan_campaign_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_google_ads_googleads_v1_services_keyword_plan_campaign_service_proto_goTypes = []interface{}{
	(*GetKeywordPlanCampaignRequest)(nil),      // 0: google.ads.googleads.v1.services.GetKeywordPlanCampaignRequest
	(*MutateKeywordPlanCampaignsRequest)(nil),  // 1: google.ads.googleads.v1.services.MutateKeywordPlanCampaignsRequest
	(*KeywordPlanCampaignOperation)(nil),       // 2: google.ads.googleads.v1.services.KeywordPlanCampaignOperation
	(*MutateKeywordPlanCampaignsResponse)(nil), // 3: google.ads.googleads.v1.services.MutateKeywordPlanCampaignsResponse
	(*MutateKeywordPlanCampaignResult)(nil),    // 4: google.ads.googleads.v1.services.MutateKeywordPlanCampaignResult
	(*field_mask.FieldMask)(nil),               // 5: google.protobuf.FieldMask
	(*resources.KeywordPlanCampaign)(nil),      // 6: google.ads.googleads.v1.resources.KeywordPlanCampaign
	(*status.Status)(nil),                      // 7: google.rpc.Status
}
var file_google_ads_googleads_v1_services_keyword_plan_campaign_service_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v1.services.MutateKeywordPlanCampaignsRequest.operations:type_name -> google.ads.googleads.v1.services.KeywordPlanCampaignOperation
	5, // 1: google.ads.googleads.v1.services.KeywordPlanCampaignOperation.update_mask:type_name -> google.protobuf.FieldMask
	6, // 2: google.ads.googleads.v1.services.KeywordPlanCampaignOperation.create:type_name -> google.ads.googleads.v1.resources.KeywordPlanCampaign
	6, // 3: google.ads.googleads.v1.services.KeywordPlanCampaignOperation.update:type_name -> google.ads.googleads.v1.resources.KeywordPlanCampaign
	7, // 4: google.ads.googleads.v1.services.MutateKeywordPlanCampaignsResponse.partial_failure_error:type_name -> google.rpc.Status
	4, // 5: google.ads.googleads.v1.services.MutateKeywordPlanCampaignsResponse.results:type_name -> google.ads.googleads.v1.services.MutateKeywordPlanCampaignResult
	0, // 6: google.ads.googleads.v1.services.KeywordPlanCampaignService.GetKeywordPlanCampaign:input_type -> google.ads.googleads.v1.services.GetKeywordPlanCampaignRequest
	1, // 7: google.ads.googleads.v1.services.KeywordPlanCampaignService.MutateKeywordPlanCampaigns:input_type -> google.ads.googleads.v1.services.MutateKeywordPlanCampaignsRequest
	6, // 8: google.ads.googleads.v1.services.KeywordPlanCampaignService.GetKeywordPlanCampaign:output_type -> google.ads.googleads.v1.resources.KeywordPlanCampaign
	3, // 9: google.ads.googleads.v1.services.KeywordPlanCampaignService.MutateKeywordPlanCampaigns:output_type -> google.ads.googleads.v1.services.MutateKeywordPlanCampaignsResponse
...
func init() { file_google_ads_googleads_v1_services_keyword_plan_campaign_service_proto_init() }
func file_google_ads_googleads_v1_services_keyword_plan_campaign_service_proto_init() {
	if File_google_ads_googleads_v1_services_keyword_plan_campaign_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v1_services_keyword_plan_campaign_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v1_services_keyword_plan_campaign_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v1_services_keyword_plan_campaign_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v1_services_keyword_plan_campaign_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v1_services_keyword_plan_campaign_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v1_services_keyword_plan_campaign_service_proto_msgTypes[2].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v1_services_keyword_plan_campaign_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v1_services_keyword_plan_campaign_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v1_services_keyword_plan_campaign_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v1_services_keyword_plan_campaign_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v1_services_keyword_plan_campaign_service_proto = out.File
	file_google_ads_googleads_v1_services_keyword_plan_campaign_service_proto_rawDesc = nil
	file_google_ads_googleads_v1_services_keyword_plan_campaign_service_proto_goTypes = nil
	file_google_ads_googleads_v1_services_keyword_plan_campaign_service_proto_depIdxs = nil
}
