...
func (x *GetKeywordViewRequest) Reset() {
	*x = GetKeywordViewRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v1_services_keyword_view_service_proto_msgTypes[0]
...
func (*GetKeywordViewRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v1_services_keyword_view_service_proto_rawDescGZIP(), []int{0}
}
...
var File_google_ads_googleads_v1_services_keyword_view_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v1_services_keyword_view_service_proto_rawDesc = []byte{
	...
	0x2e, 0x2f, 0x76, 0x31, 0x2f, 0x7b, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f, 0x6e,
...
var (
	file_google_ads_googleads_v1_services_keyword_view_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v1_services_keyword_view_service_proto_rawDescData = file_google_ads_googleads_v1_services_keyword_view_service_proto_rawDesc
)

func file_google_ads_googleads_v1_services_keyword_view_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v1_services_keyword_view_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v1_services_keyword_view_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v1_services_keyword_view_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v1_services_keyword_view_service_proto_rawDescData
}

var file_google_ads_googleads_v1_services_keyword_view_service_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v1_services_keyword_view_service_proto_goTypes = []interface{}{
	(*GetKeywordViewRequest)(nil), // 0: google.ads.googleads.v1.services.GetKeywordViewRequest
	(*resources.KeywordView)(nil), // 1: google.ads.googleads.v1.resources.KeywordView
}
var file_google_ads_googleads_v1_services_keyword_view_service_proto_depIdxs = []int32{
	0, // 0: google.ads.googleads.v1.services.KeywordViewService.GetKeywordView:input_type -> google.ads.googleads.v1.services.GetKeywordViewRequest
	1, // 1: google.ads.googleads.v1.services.KeywordViewService.GetKeywordView:output_type -> google.ads.googleads.v1.resources.KeywordView
...
func init() { file_google_ads_googleads_v1_services_keyword_view_service_proto_init() }
func file_google_ads_googleads_v1_services_keyword_view_service_proto_init() {
	if File_google_ads_googleads_v1_services_keyword_view_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v1_services_keyword_view_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v1_services_keyword_view_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v1_services_keyword_view_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v1_services_keyword_view_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v1_services_keyword_view_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v1_services_keyword_view_service_proto = out.File
	file_google_ads_googleads_v1_services_keyword_view_service_proto_rawDesc = nil
	file_google_ads_googleads_v1_services_keyword_view_service_proto_goTypes = nil
	file_google_ads_googleads_v1_services_keyword_view_service_proto_depIdxs = nil
}
