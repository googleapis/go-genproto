...
func (x *GetUserListRequest) Reset() {
	*x = GetUserListRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v1_services_user_list_service_proto_msgTypes[0]
...
func (*GetUserListRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v1_services_user_list_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *MutateUserListsRequest) Reset() {
	*x = MutateUserListsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v1_services_user_list_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateUserListsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v1_services_user_list_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *UserListOperation) Reset() {
	*x = UserListOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v1_services_user_list_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*UserListOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v1_services_user_list_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateUserListsResponse) Reset() {
	*x = MutateUserListsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v1_services_user_list_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateUserListsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v1_services_user_list_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *MutateUserListResult) Reset() {
	*x = MutateUserListResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v1_services_user_list_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateUserListResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v1_services_user_list_service_proto_rawDescGZIP(), []int{4}
}
...
var File_google_ads_googleads_v1_services_user_list_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v1_services_user_list_service_proto_rawDesc = []byte{
	...
	0x76, 0x31, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x55, 0x73, 0x65, 0x72,
...
var (
	file_google_ads_googleads_v1_services_user_list_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v1_services_user_list_service_proto_rawDescData = file_google_ads_googleads_v1_services_user_list_service_proto_rawDesc
)

func file_google_ads_googleads_v1_services_user_list_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v1_services_user_list_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v1_services_user_list_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v1_services_user_list_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v1_services_user_list_service_proto_rawDescData
}

var file_google_ads_googleads_v1_services_user_list_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_google_ads_googleads_v1_services_user_list_service_proto_goTypes = []interface{}{
	(*GetUserListRequest)(nil),      // 0: google.ads.googleads.v1.services.GetUserListRequest
	(*MutateUserListsRequest)(nil),  // 1: google.ads.googleads.v1.services.MutateUserListsRequest
	(*UserListOperation)(nil),       // 2: google.ads.googleads.v1.services.UserListOperation
	(*MutateUserListsResponse)(nil), // 3: google.ads.googleads.v1.services.MutateUserListsResponse
	(*MutateUserListResult)(nil),    // 4: google.ads.googleads.v1.services.MutateUserListResult
	(*field_mask.FieldMask)(nil),    // 5: google.protobuf.FieldMask
	(*resources.UserList)(nil),      // 6: google.ads.googleads.v1.resources.UserList
	(*status.Status)(nil),           // 7: google.rpc.Status
}
var file_google_ads_googleads_v1_services_user_list_service_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v1.services.MutateUserListsRequest.operations:type_name -> google.ads.googleads.v1.services.UserListOperation
	5, // 1: google.ads.googleads.v1.services.UserListOperation.update_mask:type_name -> google.protobuf.FieldMask
	6, // 2: google.ads.googleads.v1.services.UserListOperation.create:type_name -> google.ads.googleads.v1.resources.UserList
	6, // 3: google.ads.googleads.v1.services.UserListOperation.update:type_name -> google.ads.googleads.v1.resources.UserList
	7, // 4: google.ads.googleads.v1.services.MutateUserListsResponse.partial_failure_error:type_name -> google.rpc.Status
	4, // 5: google.ads.googleads.v1.services.MutateUserListsResponse.results:type_name -> google.ads.googleads.v1.services.MutateUserListResult
	0, // 6: google.ads.googleads.v1.services.UserListService.GetUserList:input_type -> google.ads.googleads.v1.services.GetUserListRequest
	1, // 7: google.ads.googleads.v1.services.UserListService.MutateUserLists:input_type -> google.ads.googleads.v1.services.MutateUserListsRequest
	6, // 8: google.ads.googleads.v1.services.UserListService.GetUserList:output_type -> google.ads.googleads.v1.resources.UserList
	3, // 9: google.ads.googleads.v1.services.UserListService.MutateUserLists:output_type -> google.ads.googleads.v1.services.MutateUserListsResponse
...
func init() { file_google_ads_googleads_v1_services_user_list_service_proto_init() }
func file_google_ads_googleads_v1_services_user_list_service_proto_init() {
	if File_google_ads_googleads_v1_services_user_list_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v1_services_user_list_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v1_services_user_list_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v1_services_user_list_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v1_services_user_list_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v1_services_user_list_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v1_services_user_list_service_proto_msgTypes[2].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v1_services_user_list_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v1_services_user_list_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v1_services_user_list_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v1_services_user_list_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v1_services_user_list_service_proto = out.File
	file_google_ads_googleads_v1_services_user_list_service_proto_rawDesc = nil
	file_google_ads_googleads_v1_services_user_list_service_proto_goTypes = nil
	file_google_ads_googleads_v1_services_user_list_service_proto_depIdxs = nil
}
