...
func (dst *CustomerPayPerConversionEligibilityFailureReasonEnum) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CustomerPayPerConversionEligibilityFailureReasonEnum.Merge(dst, src)
}
