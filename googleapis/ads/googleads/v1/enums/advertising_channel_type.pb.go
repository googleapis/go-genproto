...
func (AdvertisingChannelTypeEnum_AdvertisingChannelType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_advertising_channel_type_998cbc4865ac36b2, []int{0, 0}
}
...
func (*AdvertisingChannelTypeEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_advertising_channel_type_998cbc4865ac36b2, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v1/enums/advertising_channel_type.proto", fileDescriptor_advertising_channel_type_998cbc4865ac36b2)
}

var fileDescriptor_advertising_channel_type_998cbc4865ac36b2 = []byte{
