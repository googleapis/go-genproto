...
func (FeedItemQualityDisapprovalReasonEnum_FeedItemQualityDisapprovalReason) Descriptor() protoreflect.EnumDescriptor {
	return file_google_ads_googleads_v1_enums_feed_item_quality_disapproval_reason_proto_enumTypes[0].Descriptor()
}

func (FeedItemQualityDisapprovalReasonEnum_FeedItemQualityDisapprovalReason) Type() protoreflect.EnumType {
	return &file_google_ads_googleads_v1_enums_feed_item_quality_disapproval_reason_proto_enumTypes[0]
}
...
func (FeedItemQualityDisapprovalReasonEnum_FeedItemQualityDisapprovalReason) EnumDescriptor() ([]byte, []int) {
	return file_google_ads_googleads_v1_enums_feed_item_quality_disapproval_reason_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *FeedItemQualityDisapprovalReasonEnum) Reset() {
	*x = FeedItemQualityDisapprovalReasonEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v1_enums_feed_item_quality_disapproval_reason_proto_msgTypes[0]
...
func (*FeedItemQualityDisapprovalReasonEnum) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v1_enums_feed_item_quality_disapproval_reason_proto_rawDescGZIP(), []int{0}
}

var File_google_ads_googleads_v1_enums_feed_item_quality_disapproval_reason_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v1_enums_feed_item_quality_disapproval_reason_proto_rawDesc = []byte{
...
var (
	file_google_ads_googleads_v1_enums_feed_item_quality_disapproval_reason_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v1_enums_feed_item_quality_disapproval_reason_proto_rawDescData = file_google_ads_googleads_v1_enums_feed_item_quality_disapproval_reason_proto_rawDesc
)

func file_google_ads_googleads_v1_enums_feed_item_quality_disapproval_reason_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v1_enums_feed_item_quality_disapproval_reason_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v1_enums_feed_item_quality_disapproval_reason_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v1_enums_feed_item_quality_disapproval_reason_proto_rawDescData)
	})
	return file_google_ads_googleads_v1_enums_feed_item_quality_disapproval_reason_proto_rawDescData
}

var file_google_ads_googleads_v1_enums_feed_item_quality_disapproval_reason_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_google_ads_googleads_v1_enums_feed_item_quality_disapproval_reason_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v1_enums_feed_item_quality_disapproval_reason_proto_goTypes = []interface{}{
	(FeedItemQualityDisapprovalReasonEnum_FeedItemQualityDisapprovalReason)(0), // 0: google.ads.googleads.v1.enums.FeedItemQualityDisapprovalReasonEnum.FeedItemQualityDisapprovalReason
	(*FeedItemQualityDisapprovalReasonEnum)(nil),                               // 1: google.ads.googleads.v1.enums.FeedItemQualityDisapprovalReasonEnum
}
var file_google_ads_googleads_v1_enums_feed_item_quality_disapproval_reason_proto_depIdxs = []int32{
...
func init() { file_google_ads_googleads_v1_enums_feed_item_quality_disapproval_reason_proto_init() }
func file_google_ads_googleads_v1_enums_feed_item_quality_disapproval_reason_proto_init() {
	if File_google_ads_googleads_v1_enums_feed_item_quality_disapproval_reason_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v1_enums_feed_item_quality_disapproval_reason_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v1_enums_feed_item_quality_disapproval_reason_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v1_enums_feed_item_quality_disapproval_reason_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v1_enums_feed_item_quality_disapproval_reason_proto_depIdxs,
		EnumInfos:         file_google_ads_googleads_v1_enums_feed_item_quality_disapproval_reason_proto_enumTypes,
		MessageInfos:      file_google_ads_googleads_v1_enums_feed_item_quality_disapproval_reason_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v1_enums_feed_item_quality_disapproval_reason_proto = out.File
	file_google_ads_googleads_v1_enums_feed_item_quality_disapproval_reason_proto_rawDesc = nil
	file_google_ads_googleads_v1_enums_feed_item_quality_disapproval_reason_proto_goTypes = nil
	file_google_ads_googleads_v1_enums_feed_item_quality_disapproval_reason_proto_depIdxs = nil
}
