...
func (PositiveGeoTargetTypeEnum_PositiveGeoTargetType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_positive_geo_target_type_65cfa57b50394948, []int{0, 0}
}
...
func (*PositiveGeoTargetTypeEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_positive_geo_target_type_65cfa57b50394948, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v1/enums/positive_geo_target_type.proto", fileDescriptor_positive_geo_target_type_65cfa57b50394948)
}

var fileDescriptor_positive_geo_target_type_65cfa57b50394948 = []byte{
