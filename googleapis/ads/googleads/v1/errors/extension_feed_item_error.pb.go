...
func (ExtensionFeedItemErrorEnum_ExtensionFeedItemError) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_extension_feed_item_error_46ede29c0084b323, []int{0, 0}
}
...
func (*ExtensionFeedItemErrorEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_extension_feed_item_error_46ede29c0084b323, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v1/errors/extension_feed_item_error.proto", fileDescriptor_extension_feed_item_error_46ede29c0084b323)
}

var fileDescriptor_extension_feed_item_error_46ede29c0084b323 = []byte{
