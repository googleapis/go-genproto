...
func (KeywordPlanCampaignErrorEnum_KeywordPlanCampaignError) Descriptor() protoreflect.EnumDescriptor {
	return file_google_ads_googleads_v1_errors_keyword_plan_campaign_error_proto_enumTypes[0].Descriptor()
}

func (KeywordPlanCampaignErrorEnum_KeywordPlanCampaignError) Type() protoreflect.EnumType {
	return &file_google_ads_googleads_v1_errors_keyword_plan_campaign_error_proto_enumTypes[0]
}
...
func (KeywordPlanCampaignErrorEnum_KeywordPlanCampaignError) EnumDescriptor() ([]byte, []int) {
	return file_google_ads_googleads_v1_errors_keyword_plan_campaign_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *KeywordPlanCampaignErrorEnum) Reset() {
	*x = KeywordPlanCampaignErrorEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v1_errors_keyword_plan_campaign_error_proto_msgTypes[0]
...
func (*KeywordPlanCampaignErrorEnum) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v1_errors_keyword_plan_campaign_error_proto_rawDescGZIP(), []int{0}
}

var File_google_ads_googleads_v1_errors_keyword_plan_campaign_error_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v1_errors_keyword_plan_campaign_error_proto_rawDesc = []byte{
	...
	0x76, 0x31, 0x2e, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x73, 0x42, 0x1d, 0x4b, 0x65, 0x79, 0x77, 0x6f,
...
var (
	file_google_ads_googleads_v1_errors_keyword_plan_campaign_error_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v1_errors_keyword_plan_campaign_error_proto_rawDescData = file_google_ads_googleads_v1_errors_keyword_plan_campaign_error_proto_rawDesc
)

func file_google_ads_googleads_v1_errors_keyword_plan_campaign_error_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v1_errors_keyword_plan_campaign_error_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v1_errors_keyword_plan_campaign_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v1_errors_keyword_plan_campaign_error_proto_rawDescData)
	})
	return file_google_ads_googleads_v1_errors_keyword_plan_campaign_error_proto_rawDescData
}

var file_google_ads_googleads_v1_errors_keyword_plan_campaign_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_google_ads_googleads_v1_errors_keyword_plan_campaign_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v1_errors_keyword_plan_campaign_error_proto_goTypes = []interface{}{
	(KeywordPlanCampaignErrorEnum_KeywordPlanCampaignError)(0), // 0: google.ads.googleads.v1.errors.KeywordPlanCampaignErrorEnum.KeywordPlanCampaignError
	(*KeywordPlanCampaignErrorEnum)(nil),                       // 1: google.ads.googleads.v1.errors.KeywordPlanCampaignErrorEnum
}
var file_google_ads_googleads_v1_errors_keyword_plan_campaign_error_proto_depIdxs = []int32{
...
func init() { file_google_ads_googleads_v1_errors_keyword_plan_campaign_error_proto_init() }
func file_google_ads_googleads_v1_errors_keyword_plan_campaign_error_proto_init() {
	if File_google_ads_googleads_v1_errors_keyword_plan_campaign_error_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v1_errors_keyword_plan_campaign_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v1_errors_keyword_plan_campaign_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v1_errors_keyword_plan_campaign_error_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v1_errors_keyword_plan_campaign_error_proto_depIdxs,
		EnumInfos:         file_google_ads_googleads_v1_errors_keyword_plan_campaign_error_proto_enumTypes,
		MessageInfos:      file_google_ads_googleads_v1_errors_keyword_plan_campaign_error_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v1_errors_keyword_plan_campaign_error_proto = out.File
	file_google_ads_googleads_v1_errors_keyword_plan_campaign_error_proto_rawDesc = nil
	file_google_ads_googleads_v1_errors_keyword_plan_campaign_error_proto_goTypes = nil
	file_google_ads_googleads_v1_errors_keyword_plan_campaign_error_proto_depIdxs = nil
}
