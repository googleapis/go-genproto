...
func (FeedItemValidationErrorEnum_FeedItemValidationError) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_feed_item_validation_error_8d068d16857cd508, []int{0, 0}
}
...
func (*FeedItemValidationErrorEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_feed_item_validation_error_8d068d16857cd508, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v1/errors/feed_item_validation_error.proto", fileDescriptor_feed_item_validation_error_8d068d16857cd508)
}

var fileDescriptor_feed_item_validation_error_8d068d16857cd508 = []byte{
