...
func (x *GetCustomerUserAccessInvitationRequest) Reset() {
	*x = GetCustomerUserAccessInvitationRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v6_services_customer_user_access_invitation_service_proto_msgTypes[0]
...
func (*GetCustomerUserAccessInvitationRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v6_services_customer_user_access_invitation_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *MutateCustomerUserAccessInvitationRequest) Reset() {
	*x = MutateCustomerUserAccessInvitationRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v6_services_customer_user_access_invitation_service_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCustomerUserAccessInvitationRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v6_services_customer_user_access_invitation_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *CustomerUserAccessInvitationOperation) Reset() {
	*x = CustomerUserAccessInvitationOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v6_services_customer_user_access_invitation_service_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CustomerUserAccessInvitationOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v6_services_customer_user_access_invitation_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateCustomerUserAccessInvitationResponse) Reset() {
	*x = MutateCustomerUserAccessInvitationResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v6_services_customer_user_access_invitation_service_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCustomerUserAccessInvitationResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v6_services_customer_user_access_invitation_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *MutateCustomerUserAccessInvitationResult) Reset() {
	*x = MutateCustomerUserAccessInvitationResult{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v6_services_customer_user_access_invitation_service_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MutateCustomerUserAccessInvitationResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v6_services_customer_user_access_invitation_service_proto_rawDescGZIP(), []int{4}
}
...
var File_google_ads_googleads_v6_services_customer_user_access_invitation_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v6_services_customer_user_access_invitation_service_proto_rawDesc = []byte{
	...
	0x65, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x47, 0x22, 0x42, 0x2f, 0x76, 0x36, 0x2f, 0x63, 0x75, 0x73,
...
var (
	file_google_ads_googleads_v6_services_customer_user_access_invitation_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v6_services_customer_user_access_invitation_service_proto_rawDescData = file_google_ads_googleads_v6_services_customer_user_access_invitation_service_proto_rawDesc
)

func file_google_ads_googleads_v6_services_customer_user_access_invitation_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v6_services_customer_user_access_invitation_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v6_services_customer_user_access_invitation_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v6_services_customer_user_access_invitation_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v6_services_customer_user_access_invitation_service_proto_rawDescData
}

var file_google_ads_googleads_v6_services_customer_user_access_invitation_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_google_ads_googleads_v6_services_customer_user_access_invitation_service_proto_goTypes = []interface{}{
	(*GetCustomerUserAccessInvitationRequest)(nil),     // 0: google.ads.googleads.v6.services.GetCustomerUserAccessInvitationRequest
	(*MutateCustomerUserAccessInvitationRequest)(nil),  // 1: google.ads.googleads.v6.services.MutateCustomerUserAccessInvitationRequest
	(*CustomerUserAccessInvitationOperation)(nil),      // 2: google.ads.googleads.v6.services.CustomerUserAccessInvitationOperation
	(*MutateCustomerUserAccessInvitationResponse)(nil), // 3: google.ads.googleads.v6.services.MutateCustomerUserAccessInvitationResponse
	(*MutateCustomerUserAccessInvitationResult)(nil),   // 4: google.ads.googleads.v6.services.MutateCustomerUserAccessInvitationResult
	(*resources.CustomerUserAccessInvitation)(nil),     // 5: google.ads.googleads.v6.resources.CustomerUserAccessInvitation
}
var file_google_ads_googleads_v6_services_customer_user_access_invitation_service_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v6.services.MutateCustomerUserAccessInvitationRequest.operation:type_name -> google.ads.googleads.v6.services.CustomerUserAccessInvitationOperation
	5, // 1: google.ads.googleads.v6.services.CustomerUserAccessInvitationOperation.create:type_name -> google.ads.googleads.v6.resources.CustomerUserAccessInvitation
	4, // 2: google.ads.googleads.v6.services.MutateCustomerUserAccessInvitationResponse.result:type_name -> google.ads.googleads.v6.services.MutateCustomerUserAccessInvitationResult
	0, // 3: google.ads.googleads.v6.services.CustomerUserAccessInvitationService.GetCustomerUserAccessInvitation:input_type -> google.ads.googleads.v6.services.GetCustomerUserAccessInvitationRequest
	1, // 4: google.ads.googleads.v6.services.CustomerUserAccessInvitationService.MutateCustomerUserAccessInvitation:input_type -> google.ads.googleads.v6.services.MutateCustomerUserAccessInvitationRequest
	5, // 5: google.ads.googleads.v6.services.CustomerUserAccessInvitationService.GetCustomerUserAccessInvitation:output_type -> google.ads.googleads.v6.resources.CustomerUserAccessInvitation
	3, // 6: google.ads.googleads.v6.services.CustomerUserAccessInvitationService.MutateCustomerUserAccessInvitation:output_type -> google.ads.googleads.v6.services.MutateCustomerUserAccessInvitationResponse
...
func init() {
	file_google_ads_googleads_v6_services_customer_user_access_invitation_service_proto_init()
}
func file_google_ads_googleads_v6_services_customer_user_access_invitation_service_proto_init() {
	if File_google_ads_googleads_v6_services_customer_user_access_invitation_service_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v6_services_customer_user_access_invitation_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v6_services_customer_user_access_invitation_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v6_services_customer_user_access_invitation_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v6_services_customer_user_access_invitation_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_ads_googleads_v6_services_customer_user_access_invitation_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_ads_googleads_v6_services_customer_user_access_invitation_service_proto_msgTypes[2].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v6_services_customer_user_access_invitation_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v6_services_customer_user_access_invitation_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v6_services_customer_user_access_invitation_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v6_services_customer_user_access_invitation_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v6_services_customer_user_access_invitation_service_proto = out.File
	file_google_ads_googleads_v6_services_customer_user_access_invitation_service_proto_rawDesc = nil
	file_google_ads_googleads_v6_services_customer_user_access_invitation_service_proto_goTypes = nil
	file_google_ads_googleads_v6_services_customer_user_access_invitation_service_proto_depIdxs = nil
}
...
func (c *customerUserAccessInvitationServiceClient) GetCustomerUserAccessInvitation(ctx context.Context, in *GetCustomerUserAccessInvitationRequest, opts ...grpc.CallOption) (*resources.CustomerUserAccessInvitation, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v6.services.CustomerUserAccessInvitationService/GetCustomerUserAccessInvitation", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *customerUserAccessInvitationServiceClient) MutateCustomerUserAccessInvitation(ctx context.Context, in *MutateCustomerUserAccessInvitationRequest, opts ...grpc.CallOption) (*MutateCustomerUserAccessInvitationResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v6.services.CustomerUserAccessInvitationService/MutateCustomerUserAccessInvitation", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CustomerUserAccessInvitationService_GetCustomerUserAccessInvitation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v6.services.CustomerUserAccessInvitationService/GetCustomerUserAccessInvitation",
	}
...
func _CustomerUserAccessInvitationService_MutateCustomerUserAccessInvitation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v6.services.CustomerUserAccessInvitationService/MutateCustomerUserAccessInvitation",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _CustomerUserAccessInvitationService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "google.ads.googleads.v6.services.CustomerUserAccessInvitationService",
	...
	Metadata: "google/ads/googleads/v6/services/customer_user_access_invitation_service.proto",
}
