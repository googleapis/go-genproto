...
func (c *campaignAssetServiceClient) GetCampaignAsset(ctx context.Context, in *GetCampaignAssetRequest, opts ...grpc.CallOption) (*resources.CampaignAsset, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v6.services.CampaignAssetService/GetCampaignAsset", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *campaignAssetServiceClient) MutateCampaignAssets(ctx context.Context, in *MutateCampaignAssetsRequest, opts ...grpc.CallOption) (*MutateCampaignAssetsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v6.services.CampaignAssetService/MutateCampaignAssets", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CampaignAssetService_GetCampaignAsset_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v6.services.CampaignAssetService/GetCampaignAsset",
	}
...
func _CampaignAssetService_MutateCampaignAssets_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v6.services.CampaignAssetService/MutateCampaignAssets",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _CampaignAssetService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "google.ads.googleads.v6.services.CampaignAssetService",
	...
	Metadata: "google/ads/googleads/v6/services/campaign_asset_service.proto",
}
