...
func init() {
	proto.RegisterFile("google/iam/credentials/v1/iamcredentials.proto", fileDescriptor_iamcredentials_03d0b597c179fd49)
}

var fileDescriptor_iamcredentials_03d0b597c179fd49 = []byte{
