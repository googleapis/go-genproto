...
func init() {
	proto.RegisterFile("google/iam/credentials/v1/iamcredentials.proto", fileDescriptor_iamcredentials_03ba083e7e8867ec)
}

var fileDescriptor_iamcredentials_03ba083e7e8867ec = []byte{
