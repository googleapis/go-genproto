...
func (*GenerateAccessTokenRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_f41ae9f35d063a8f, []int{0}
}
...
func (*GenerateAccessTokenResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_f41ae9f35d063a8f, []int{1}
}
...
func (*SignBlobRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_f41ae9f35d063a8f, []int{2}
}
...
func (*SignBlobResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_f41ae9f35d063a8f, []int{3}
}
...
func (*SignJwtRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_f41ae9f35d063a8f, []int{4}
}
...
func (*SignJwtResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_f41ae9f35d063a8f, []int{5}
}
...
func (*GenerateIdTokenRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_f41ae9f35d063a8f, []int{6}
}
...
func (*GenerateIdTokenResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_f41ae9f35d063a8f, []int{7}
}
...
func (*GenerateIdentityBindingAccessTokenRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_f41ae9f35d063a8f, []int{8}
}
...
func (*GenerateIdentityBindingAccessTokenResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_f41ae9f35d063a8f, []int{9}
}
...
func init() {
	proto.RegisterFile("google/iam/credentials/v1/common.proto", fileDescriptor_common_f41ae9f35d063a8f)
}

var fileDescriptor_common_f41ae9f35d063a8f = []byte{
