...
func (*AuditData) Descriptor() ([]byte, []int) {
	return fileDescriptor_audit_data_25c24f9d71f1cfd7, []int{0}
}
...
func init() {
	proto.RegisterFile("google/iam/v1/logging/audit_data.proto", fileDescriptor_audit_data_25c24f9d71f1cfd7)
}

var fileDescriptor_audit_data_25c24f9d71f1cfd7 = []byte{
