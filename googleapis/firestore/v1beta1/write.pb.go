...
func (DocumentTransform_FieldTransform_ServerValue) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_write_f7b2ce45bbcfd263, []int{1, 0, 0}
}
...
func (*Write) Descriptor() ([]byte, []int) {
	return fileDescriptor_write_f7b2ce45bbcfd263, []int{0}
}
...
func (*DocumentTransform) Descriptor() ([]byte, []int) {
	return fileDescriptor_write_f7b2ce45bbcfd263, []int{1}
}
...
func (*DocumentTransform_FieldTransform) Descriptor() ([]byte, []int) {
	return fileDescriptor_write_f7b2ce45bbcfd263, []int{1, 0}
}
...
func (*WriteResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_write_f7b2ce45bbcfd263, []int{2}
}
...
func (*DocumentChange) Descriptor() ([]byte, []int) {
	return fileDescriptor_write_f7b2ce45bbcfd263, []int{3}
}
...
func (*DocumentDelete) Descriptor() ([]byte, []int) {
	return fileDescriptor_write_f7b2ce45bbcfd263, []int{4}
}
...
func (*DocumentRemove) Descriptor() ([]byte, []int) {
	return fileDescriptor_write_f7b2ce45bbcfd263, []int{5}
}
...
func (*ExistenceFilter) Descriptor() ([]byte, []int) {
	return fileDescriptor_write_f7b2ce45bbcfd263, []int{6}
}
...
func init() {
	proto.RegisterFile("google/firestore/v1beta1/write.proto", fileDescriptor_write_f7b2ce45bbcfd263)
}

var fileDescriptor_write_f7b2ce45bbcfd263 = []byte{
