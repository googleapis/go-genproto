...
func (DocumentTransform_FieldTransform_ServerValue) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_write_eb79362ef1c70b97, []int{1, 0, 0}
}
...
func (*Write) Descriptor() ([]byte, []int) {
	return fileDescriptor_write_eb79362ef1c70b97, []int{0}
}
...
func (*DocumentTransform) Descriptor() ([]byte, []int) {
	return fileDescriptor_write_eb79362ef1c70b97, []int{1}
}
...
func (*DocumentTransform_FieldTransform) Descriptor() ([]byte, []int) {
	return fileDescriptor_write_eb79362ef1c70b97, []int{1, 0}
}
...
func (*WriteResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_write_eb79362ef1c70b97, []int{2}
}
...
func (*DocumentChange) Descriptor() ([]byte, []int) {
	return fileDescriptor_write_eb79362ef1c70b97, []int{3}
}
...
func (*DocumentDelete) Descriptor() ([]byte, []int) {
	return fileDescriptor_write_eb79362ef1c70b97, []int{4}
}
...
func (*DocumentRemove) Descriptor() ([]byte, []int) {
	return fileDescriptor_write_eb79362ef1c70b97, []int{5}
}
...
func (*ExistenceFilter) Descriptor() ([]byte, []int) {
	return fileDescriptor_write_eb79362ef1c70b97, []int{6}
}
...
func init() {
	proto.RegisterFile("google/firestore/v1/write.proto", fileDescriptor_write_eb79362ef1c70b97)
}

var fileDescriptor_write_eb79362ef1c70b97 = []byte{
