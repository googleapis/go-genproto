...
func (IndexField_Mode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_index_6cc09157d7fa246c, []int{0, 0}
}
...
func (Index_State) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_index_6cc09157d7fa246c, []int{1, 0}
}
...
func (*IndexField) Descriptor() ([]byte, []int) {
	return fileDescriptor_index_6cc09157d7fa246c, []int{0}
}
...
func (*Index) Descriptor() ([]byte, []int) {
	return fileDescriptor_index_6cc09157d7fa246c, []int{1}
}
...
func init() {
	proto.RegisterFile("google/firestore/admin/v1beta1/index.proto", fileDescriptor_index_6cc09157d7fa246c)
}

var fileDescriptor_index_6cc09157d7fa246c = []byte{
