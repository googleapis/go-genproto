...
func (*UnimplementedBotsServer) PostBotEventTemp(ctx context.Context, req *PostBotEventTempRequest) (*empty.Empty, error) {
	return nil, status1.Errorf(codes.Unimplemented, "method PostBotEventTemp not implemented")
}
