...
func (BotStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_bots_0fa217a861a9a803, []int{0}
}
...
func (LeaseState) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_bots_0fa217a861a9a803, []int{1}
}
...
func (AdminTemp_Command) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_bots_0fa217a861a9a803, []int{2, 0}
}
...
func (PostBotEventTempRequest_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_bots_0fa217a861a9a803, []int{5, 0}
}
...
func (*AdminTemp) Descriptor() ([]byte, []int) {
	return fileDescriptor_bots_0fa217a861a9a803, []int{2}
}
...
func (*CreateBotSessionRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_bots_0fa217a861a9a803, []int{3}
}
...
func (*UpdateBotSessionRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_bots_0fa217a861a9a803, []int{4}
}
...
func (*PostBotEventTempRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_bots_0fa217a861a9a803, []int{5}
}
...
func init() {
	proto.RegisterFile("google/devtools/remoteworkers/v1test2/bots.proto", fileDescriptor_bots_0fa217a861a9a803)
}

var fileDescriptor_bots_0fa217a861a9a803 = []byte{
