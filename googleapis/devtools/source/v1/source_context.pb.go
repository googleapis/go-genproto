...
func (AliasContext_Kind) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_source_context_95d7fc1394bb1b31, []int{2, 0}
}
...
func (*SourceContext) Descriptor() ([]byte, []int) {
	return fileDescriptor_source_context_95d7fc1394bb1b31, []int{0}
}
...
func (*ExtendedSourceContext) Descriptor() ([]byte, []int) {
	return fileDescriptor_source_context_95d7fc1394bb1b31, []int{1}
}
...
func (*AliasContext) Descriptor() ([]byte, []int) {
	return fileDescriptor_source_context_95d7fc1394bb1b31, []int{2}
}
...
func (*CloudRepoSourceContext) Descriptor() ([]byte, []int) {
	return fileDescriptor_source_context_95d7fc1394bb1b31, []int{3}
}
...
func (*CloudWorkspaceSourceContext) Descriptor() ([]byte, []int) {
	return fileDescriptor_source_context_95d7fc1394bb1b31, []int{4}
}
...
func (*GerritSourceContext) Descriptor() ([]byte, []int) {
	return fileDescriptor_source_context_95d7fc1394bb1b31, []int{5}
}
...
func (*GitSourceContext) Descriptor() ([]byte, []int) {
	return fileDescriptor_source_context_95d7fc1394bb1b31, []int{6}
}
...
func (*RepoId) Descriptor() ([]byte, []int) {
	return fileDescriptor_source_context_95d7fc1394bb1b31, []int{7}
}
...
func (*ProjectRepoId) Descriptor() ([]byte, []int) {
	return fileDescriptor_source_context_95d7fc1394bb1b31, []int{8}
}
...
func (*CloudWorkspaceId) Descriptor() ([]byte, []int) {
	return fileDescriptor_source_context_95d7fc1394bb1b31, []int{9}
}
...
func init() {
	proto.RegisterFile("google/devtools/source/v1/source_context.proto", fileDescriptor_source_context_95d7fc1394bb1b31)
}

var fileDescriptor_source_context_95d7fc1394bb1b31 = []byte{
