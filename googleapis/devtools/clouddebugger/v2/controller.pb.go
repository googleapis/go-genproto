...
func (*RegisterDebuggeeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_controller_a5860eef34f5ab07, []int{0}
}
...
func (*RegisterDebuggeeResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_controller_a5860eef34f5ab07, []int{1}
}
...
func (*ListActiveBreakpointsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_controller_a5860eef34f5ab07, []int{2}
}
...
func (*ListActiveBreakpointsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_controller_a5860eef34f5ab07, []int{3}
}
...
func (*UpdateActiveBreakpointRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_controller_a5860eef34f5ab07, []int{4}
}
...
func (*UpdateActiveBreakpointResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_controller_a5860eef34f5ab07, []int{5}
}
...
func init() {
	proto.RegisterFile("google/devtools/clouddebugger/v2/controller.proto", fileDescriptor_controller_a5860eef34f5ab07)
}

var fileDescriptor_controller_a5860eef34f5ab07 = []byte{
