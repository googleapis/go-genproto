...
func (*ScanConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_containeranalysis_0620917dfaf828c6, []int{0}
}
...
func (*GetScanConfigRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_containeranalysis_0620917dfaf828c6, []int{1}
}
...
func (*ListScanConfigsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_containeranalysis_0620917dfaf828c6, []int{2}
}
...
func (*ListScanConfigsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_containeranalysis_0620917dfaf828c6, []int{3}
}
...
func (*UpdateScanConfigRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_containeranalysis_0620917dfaf828c6, []int{4}
}
...
func init() {
	proto.RegisterFile("google/devtools/containeranalysis/v1beta1/containeranalysis.proto", fileDescriptor_containeranalysis_0620917dfaf828c6)
}

var fileDescriptor_containeranalysis_0620917dfaf828c6 = []byte{
