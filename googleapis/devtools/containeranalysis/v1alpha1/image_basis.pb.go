...
func (DockerImage_Layer_Directive) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_image_basis_d44a570647a88cb8, []int{0, 0, 0}
}
...
func (*DockerImage) Descriptor() ([]byte, []int) {
	return fileDescriptor_image_basis_d44a570647a88cb8, []int{0}
}
...
func (*DockerImage_Layer) Descriptor() ([]byte, []int) {
	return fileDescriptor_image_basis_d44a570647a88cb8, []int{0, 0}
}
...
func (*DockerImage_Fingerprint) Descriptor() ([]byte, []int) {
	return fileDescriptor_image_basis_d44a570647a88cb8, []int{0, 1}
}
...
func (*DockerImage_Basis) Descriptor() ([]byte, []int) {
	return fileDescriptor_image_basis_d44a570647a88cb8, []int{0, 2}
}
...
func (*DockerImage_Derived) Descriptor() ([]byte, []int) {
	return fileDescriptor_image_basis_d44a570647a88cb8, []int{0, 3}
}
...
var fileDescriptor_image_basis_d44a570647a88cb8 = []byte{
