...
func (PackageManager_Architecture) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_bill_of_materials_5994c0bb5dadb2f3, []int{0, 0}
}
...
func (*PackageManager) Descriptor() ([]byte, []int) {
	return fileDescriptor_bill_of_materials_5994c0bb5dadb2f3, []int{0}
}
...
func (*PackageManager_Location) Descriptor() ([]byte, []int) {
	return fileDescriptor_bill_of_materials_5994c0bb5dadb2f3, []int{0, 1}
}
...
func (*PackageManager_Package) Descriptor() ([]byte, []int) {
	return fileDescriptor_bill_of_materials_5994c0bb5dadb2f3, []int{0, 2}
}
...
func (*PackageManager_Installation) Descriptor() ([]byte, []int) {
	return fileDescriptor_bill_of_materials_5994c0bb5dadb2f3, []int{0, 3}
}
...
func init() {
	proto.RegisterFile("google/devtools/containeranalysis/v1alpha1/bill_of_materials.proto", fileDescriptor_bill_of_materials_5994c0bb5dadb2f3)
}

var fileDescriptor_bill_of_materials_5994c0bb5dadb2f3 = []byte{
