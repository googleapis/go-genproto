...
func (PublishLifecycleEventRequest_ServiceLevel) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_publish_build_event_d745bb02eff36c4f, []int{0, 0}
}
...
func (*PublishLifecycleEventRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_publish_build_event_d745bb02eff36c4f, []int{0}
}
...
func (*PublishBuildToolEventStreamResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_publish_build_event_d745bb02eff36c4f, []int{1}
}
...
func (*OrderedBuildEvent) Descriptor() ([]byte, []int) {
	return fileDescriptor_publish_build_event_d745bb02eff36c4f, []int{2}
}
...
func (*PublishBuildToolEventStreamRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_publish_build_event_d745bb02eff36c4f, []int{3}
}
...
func init() {
	proto.RegisterFile("google/devtools/build/v1/publish_build_event.proto", fileDescriptor_publish_build_event_d745bb02eff36c4f)
}

var fileDescriptor_publish_build_event_d745bb02eff36c4f = []byte{
