...
var file_google_apps_drive_activity_v2_actor_proto_goTypes = []any{
...
func file_google_apps_drive_activity_v2_actor_proto_init() {
	...
	file_google_apps_drive_activity_v2_actor_proto_msgTypes[0].OneofWrappers = []any{
		(*Actor_User)(nil),
		(*Actor_Anonymous)(nil),
	...
	file_google_apps_drive_activity_v2_actor_proto_msgTypes[1].OneofWrappers = []any{
		(*User_KnownUser_)(nil),
