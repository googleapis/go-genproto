...
//
// Deprecated: Marked as deprecated in google/apps/drive/activity/v2/target.proto.
...
var file_google_apps_drive_activity_v2_target_proto_goTypes = []any{
...
func file_google_apps_drive_activity_v2_target_proto_init() {
	...
	file_google_apps_drive_activity_v2_target_proto_msgTypes[0].OneofWrappers = []any{
		(*Target_DriveItem)(nil),
		(*Target_Drive)(nil),
		(*Target_FileComment)(nil),
	}
	file_google_apps_drive_activity_v2_target_proto_msgTypes[1].OneofWrappers = []any{
		(*TargetReference_DriveItem)(nil),
		(*TargetReference_Drive)(nil),
	}
	file_google_apps_drive_activity_v2_target_proto_msgTypes[3].OneofWrappers = []any{
		(*DriveItem_DriveFile_)(nil),
		(*DriveItem_DriveFolder_)(nil),
	}
	file_google_apps_drive_activity_v2_target_proto_msgTypes[4].OneofWrappers = []any{
		(*Owner_User)(nil),
		(*Owner_Drive)(nil),
	}
	file_google_apps_drive_activity_v2_target_proto_msgTypes[7].OneofWrappers = []any{
