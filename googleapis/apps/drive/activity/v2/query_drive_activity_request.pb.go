...
var file_google_apps_drive_activity_v2_query_drive_activity_request_proto_goTypes = []any{
...
func file_google_apps_drive_activity_v2_query_drive_activity_request_proto_init() {
	...
	file_google_apps_drive_activity_v2_query_drive_activity_request_proto_msgTypes[0].OneofWrappers = []any{
		(*QueryDriveActivityRequest_ItemName)(nil),
		(*QueryDriveActivityRequest_AncestorName)(nil),
	}
	file_google_apps_drive_activity_v2_query_drive_activity_request_proto_msgTypes[1].OneofWrappers = []any{
