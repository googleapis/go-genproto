...
var file_google_apps_drive_labels_v2_requests_proto_goTypes = []any{
...
func file_google_apps_drive_labels_v2_requests_proto_init() {
	...
	file_google_apps_drive_labels_v2_requests_proto_msgTypes[0].OneofWrappers = []any{
		(*WriteControl_RequiredRevisionId)(nil),
	}
	file_google_apps_drive_labels_v2_requests_proto_msgTypes[8].OneofWrappers = []any{
		(*ListLabelsRequest_UseAdminAccess)(nil),
		(*ListLabelsRequest_MinimumRole)(nil),
	}
	file_google_apps_drive_labels_v2_requests_proto_msgTypes[24].OneofWrappers = []any{
	...
	file_google_apps_drive_labels_v2_requests_proto_msgTypes[31].OneofWrappers = []any{
	...
	file_google_apps_drive_labels_v2_requests_proto_msgTypes[37].OneofWrappers = []any{
