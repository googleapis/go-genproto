...
var file_google_apps_script_type_gmail_gmail_addon_manifest_proto_goTypes = []any{
...
func file_google_apps_script_type_gmail_gmail_addon_manifest_proto_init() {
	...
	file_google_apps_script_type_gmail_gmail_addon_manifest_proto_msgTypes[1].OneofWrappers = []any{
		(*UniversalAction_OpenLink)(nil),
		(*UniversalAction_RunFunction)(nil),
	}
	file_google_apps_script_type_gmail_gmail_addon_manifest_proto_msgTypes[3].OneofWrappers = []any{
