...
func init() {
	proto.RegisterFile("google/bigtable/admin/table/v1/bigtable_table_service.proto", fileDescriptor_bigtable_table_service_be80dba644cb3823)
}

var fileDescriptor_bigtable_table_service_be80dba644cb3823 = []byte{
