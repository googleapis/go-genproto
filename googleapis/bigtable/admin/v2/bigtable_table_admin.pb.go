...
// The request for
// [CreateView][google.bigtable.admin.v2.BigtableTableAdmin.CreateView]
...
// The metadata for the Operation returned by CreateView.
type CreateViewMetadata struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// The request that prompted the initiation of this CreateInstance operation.
	OriginalRequest *CreateViewRequest `protobuf:"bytes,1,opt,name=original_request,json=originalRequest,proto3" json:"original_request,omitempty"`
	// The time at which the original request was received.
	RequestTime *timestamppb.Timestamp `protobuf:"bytes,2,opt,name=request_time,json=requestTime,proto3" json:"request_time,omitempty"`
	// The time at which the operation failed or was completed successfully.
	FinishTime *timestamppb.Timestamp `protobuf:"bytes,3,opt,name=finish_time,json=finishTime,proto3" json:"finish_time,omitempty"`
...
func (x *CreateViewMetadata) Reset() {
	*x = CreateViewMetadata{}
	if protoimpl.UnsafeEnabled {
...
func (x *CreateViewMetadata) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CreateViewMetadata) ProtoMessage() {}

func (x *CreateViewMetadata) ProtoReflect() protoreflect.Message {
	mi := &file_google_bigtable_admin_v2_bigtable_table_admin_proto_msgTypes[36]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CreateViewMetadata.ProtoReflect.Descriptor instead.
func (*CreateViewMetadata) Descriptor() ([]byte, []int) {
	return file_google_bigtable_admin_v2_bigtable_table_admin_proto_rawDescGZIP(), []int{36}
}

func (x *CreateViewMetadata) GetOriginalRequest() *CreateViewRequest {
	if x != nil {
		return x.OriginalRequest
	}
	return nil
...
func (x *CreateViewMetadata) GetRequestTime() *timestamppb.Timestamp {
	if x != nil {
		return x.RequestTime
	}
	return nil
...
func (x *CreateViewMetadata) GetFinishTime() *timestamppb.Timestamp {
	if x != nil {
		return x.FinishTime
	}
	return nil
...
// Request message for
// [google.bigtable.admin.v2.BigtableTableAdmin.ListViews][google.bigtable.admin.v2.BigtableTableAdmin.ListViews]
type ListViewsRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Required. The unique name of the table for which views should be listed.
	// Values are of the form
	// `projects/{project}/instances/{instance}/tables/{table}`.
	Parent string `protobuf:"bytes,1,opt,name=parent,proto3" json:"parent,omitempty"`
	// Maximum number of results per page.
	...
	// The value of `next_page_token` returned by a previous call.
	PageToken string `protobuf:"bytes,3,opt,name=page_token,json=pageToken,proto3" json:"page_token,omitempty"`
	// The resource_view to be applied to the returned views' fields.
	// Default to NAME_ONLY.
	View View_ResponseView `protobuf:"varint,4,opt,name=view,proto3,enum=google.bigtable.admin.v2.View_ResponseView" json:"view,omitempty"`
}
...
func (x *ListViewsRequest) GetView() View_ResponseView {
	if x != nil {
		return x.View
	}
	return View_RESPONSE_VIEW_UNSPECIFIED
}
...
type ListViewsResponse struct {
	...
	// The views present in the requested table.
...
// Request message for
// [google.bigtable.admin.v2.BigtableTableAdmin.GetView][google.bigtable.admin.v2.BigtableTableAdmin.GetView]
type GetViewRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Required. The unique name of the requested view.
	// Values are of the form
	// `projects/{project}/instances/{instance}/tables/{table}/views/{view}`.
	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	// The resource_view to be applied to the returned views' fields.
	// Default to BASIC.
	View View_ResponseView `protobuf:"varint,2,opt,name=view,proto3,enum=google.bigtable.admin.v2.View_ResponseView" json:"view,omitempty"`
}
...
func (x *GetViewRequest) GetView() View_ResponseView {
	if x != nil {
		return x.View
	}
	return View_RESPONSE_VIEW_UNSPECIFIED
...
// The request for
// [UpdateView][google.bigtable.admin.v2.BigtableTableAdmin.UpdateView].
type UpdateViewRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Required. The view to update. The `name` in `view` is used to identify the
	// view. View name must in this format
	// projects/<project>/instances/<instance>/tables/<table>/views/<view>
	View *View `protobuf:"bytes,1,opt,name=view,proto3" json:"view,omitempty"`
	// Required. The list of fields to update.
	// A mask specifying which fields in the View resource should be updated. This
	// mask is relative to the View resource, not to the request message. A field
...
// [UpdateView][google.bigtable.admin.v2.BigtableTableAdmin.UpdateView].
type UpdateViewMetadata struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// The request that prompted the initiation of this UpdateView operation.
	OriginalRequest *UpdateViewRequest `protobuf:"bytes,1,opt,name=original_request,json=originalRequest,proto3" json:"original_request,omitempty"`
	// The time at which the original request was received.
	RequestTime *timestamppb.Timestamp `protobuf:"bytes,2,opt,name=request_time,json=requestTime,proto3" json:"request_time,omitempty"`
	// The time at which the operation failed or was completed successfully.
	FinishTime *timestamppb.Timestamp `protobuf:"bytes,3,opt,name=finish_time,json=finishTime,proto3" json:"finish_time,omitempty"`
...
func (x *UpdateViewMetadata) Reset() {
	*x = UpdateViewMetadata{}
	if protoimpl.UnsafeEnabled {
...
func (x *UpdateViewMetadata) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpdateViewMetadata) ProtoMessage() {}

func (x *UpdateViewMetadata) ProtoReflect() protoreflect.Message {
	mi := &file_google_bigtable_admin_v2_bigtable_table_admin_proto_msgTypes[41]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UpdateViewMetadata.ProtoReflect.Descriptor instead.
func (*UpdateViewMetadata) Descriptor() ([]byte, []int) {
	return file_google_bigtable_admin_v2_bigtable_table_admin_proto_rawDescGZIP(), []int{41}
}

func (x *UpdateViewMetadata) GetOriginalRequest() *UpdateViewRequest {
	if x != nil {
		return x.OriginalRequest
	}
	return nil
...
func (x *UpdateViewMetadata) GetRequestTime() *timestamppb.Timestamp {
	if x != nil {
		return x.RequestTime
	}
	return nil
...
func (x *UpdateViewMetadata) GetFinishTime() *timestamppb.Timestamp {
	if x != nil {
		return x.FinishTime
	}
	return nil
...
// Request message for
// [google.bigtable.admin.v2.BigtableTableAdmin.DeleteView][google.bigtable.admin.v2.BigtableTableAdmin.DeleteView]
type DeleteViewRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Required. The unique name of the view to be deleted.
	// Values are of the form
	// `projects/{project}/instances/{instance}/tables/{table}/views/{view}`.
	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	// Optional. The current etag of the view.
	// If an etag is provided and does not match the current etag of the view,
...
func (x *DeleteViewRequest) GetEtag() string {
	if x != nil {
		return x.Etag
	}
	return ""
...
var file_google_bigtable_admin_v2_bigtable_table_admin_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x6d, 0x70, 0x52, 0x07, 0x65, 0x6e, 0x64, 0x54, 0x69, 0x6d, 0x65, 0x22, 0xb7, 0x03,
	...
	,
	...
	0x48, 0x00, 0x52, 0x06, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x12, 0x14, 0x0a, 0x04, 0x64, 0x72,
	0x6f, 0x70, 0x18, 0x04, 0x20, 0x01, 0x28, 0x08, 0x48, 0x00, 0x52, 0x04, 0x64, 0x72, 0x6f, 0x70,
	0x42, 0x05, 0x0a, 0x03, 0x6d, 0x6f, 0x64, 0x22, 0x61, 0x0a, 0x1f, 0x47, 0x65, 0x6e, 0x65, 0x72,
	0x61, 0x74, 0x65, 0x43, 0x6f, 0x6e, 0x73, 0x69, 0x73, 0x74, 0x65, 0x6e, 0x63, 0x79, 0x54, 0x6f,
	0x6b, 0x65, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x3e, 0x0a, 0x04, 0x6e, 0x61,
	...
	0x61, 0x62, 0x6c, 0x65, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0x4f, 0x0a, 0x20, 0x47, 0x65,
	0x6e, 0x65, 0x72, 0x61, 0x74, 0x65, 0x43, 0x6f, 0x6e, 0x73, 0x69, 0x73, 0x74, 0x65, 0x6e, 0x63,
	0x79, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x2b,
	0x0a, 0x11, 0x63, 0x6f, 0x6e, 0x73, 0x69, 0x73, 0x74, 0x65, 0x6e, 0x63, 0x79, 0x5f, 0x74, 0x6f,
	0x6b, 0x65, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x10, 0x63, 0x6f, 0x6e, 0x73, 0x69,
	0x73, 0x74, 0x65, 0x6e, 0x63, 0x79, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x8b, 0x01, 0x0a, 0x17,
	...
	,
	...
	0x6d, 0x65, 0x22, 0xd2, 0x01, 0x0a, 0x10, 0x4c, 0x69, 0x73, 0x74, 0x56, 0x69, 0x65, 0x77, 0x73,
	...
	0x21, 0x62, 0x69, 0x67, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x61, 0x64, 0x6d, 0x69, 0x6e, 0x2e, 0x67,
	0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x70, 0x69, 0x73, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x56, 0x69,
	...
	,
	...
	0x65, 0x56, 0x69, 0x65, 0x77, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x52, 0x0f, 0x6f, 0x72,
	...
	,
	...
	0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x62, 0x69, 0x67, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x2e, 0x61, 0x64,
	0x6d, 0x69, 0x6e, 0x2e, 0x76, 0x32, 0x2e, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x22, 0x4d, 0xda, 0x41,
	0x15, 0x70, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x2c, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x5f, 0x69, 0x64,
	0x2c, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x2f, 0x3a, 0x01, 0x2a, 0x22,
	...
	0x73, 0x2f, 0x2a, 0x7d, 0x2f, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x73, 0x12, 0x8a, 0x02, 0x0a, 0x17,
	...
	0x22, 0x95, 0x01, 0xca, 0x41, 0x28, 0x0a, 0x05, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x12, 0x1f, 0x43,
	0x72, 0x65, 0x61, 0x74, 0x65, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x46, 0x72, 0x6f, 0x6d, 0x53, 0x6e,
	0x61, 0x70, 0x73, 0x68, 0x6f, 0x74, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0xda, 0x41,
	0x1f, 0x70, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x2c, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x5f, 0x69, 0x64,
	0x2c, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f, 0x73, 0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f, 0x74,
	0x82, 0xd3, 0xe4, 0x93, 0x02, 0x42, 0x3a, 0x01, 0x2a, 0x22, 0x3d, 0x2f, 0x76, 0x32, 0x2f, 0x7b,
	...
	0x53, 0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f, 0x74, 0x12, 0xa4, 0x01, 0x0a, 0x0a, 0x4c, 0x69, 0x73,
	...
	0x61, 0x6e, 0x63, 0x65, 0x73, 0x2f, 0x2a, 0x7d, 0x2f, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x73, 0x12,
	...
	0x2e, 0x62, 0x69, 0x67, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x2e, 0x61, 0x64, 0x6d, 0x69, 0x6e, 0x2e,
	0x76, 0x32, 0x2e, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x22, 0x39, 0xda, 0x41, 0x04, 0x6e, 0x61, 0x6d,
	0x65, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x2c, 0x12, 0x2a, 0x2f, 0x76, 0x32, 0x2f, 0x7b, 0x6e, 0x61,
	...
	0x2f, 0x2a, 0x7d, 0x12, 0xce, 0x01, 0x0a, 0x0b, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x54, 0x61,
	...
	0x74, 0x1a, 0x1d, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x6c, 0x6f, 0x6e, 0x67, 0x72,
	0x75, 0x6e, 0x6e, 0x69, 0x6e, 0x67, 0x2e, 0x4f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	0x22, 0x72, 0xca, 0x41, 0x1c, 0x0a, 0x05, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x12, 0x13, 0x55, 0x70,
	0x64, 0x61, 0x74, 0x65, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74,
	0x61, 0xda, 0x41, 0x11, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x2c, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65,
	0x5f, 0x6d, 0x61, 0x73, 0x6b, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x39, 0x3a, 0x05, 0x74, 0x61, 0x62,
	0x6c, 0x65, 0x32, 0x30, 0x2f, 0x76, 0x32, 0x2f, 0x7b, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x2e, 0x6e,
	...
	0x73, 0x2f, 0x2a, 0x7d, 0x12, 0x8e, 0x01, 0x0a, 0x0b, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x54,
	...
	0x61, 0x6d, 0x65, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x2c, 0x2a, 0x2a, 0x2f, 0x76, 0x32, 0x2f, 0x7b,
	0x6e, 0x61, 0x6d, 0x65, 0x3d, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x73, 0x2f, 0x2a, 0x2f,
	0x69, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x73, 0x2f, 0x2a, 0x2f, 0x74, 0x61, 0x62, 0x6c,
	0x65, 0x73, 0x2f, 0x2a, 0x7d, 0x12, 0xc6, 0x01, 0x0a, 0x0d, 0x55, 0x6e, 0x64, 0x65, 0x6c, 0x65,
	...
	0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x66, 0xca, 0x41, 0x1e, 0x0a, 0x05, 0x54, 0x61, 0x62,
	0x6c, 0x65, 0x12, 0x15, 0x55, 0x6e, 0x64, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x54, 0x61, 0x62, 0x6c,
	...
	,
	...
	0x93, 0x02, 0x34, 0x12, 0x32, 0x2f, 0x76, 0x32, 0x2f, 0x7b, 0x70, 0x61, 0x72, 0x65, 0x6e, 0x74,
	0x3d, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x73, 0x2f, 0x2a, 0x2f, 0x69, 0x6e, 0x73, 0x74,
	0x61, 0x6e, 0x63, 0x65, 0x73, 0x2f, 0x2a, 0x2f, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x73, 0x2f, 0x2a,
	0x7d, 0x2f, 0x76, 0x69, 0x65, 0x77, 0x73, 0x12, 0x96, 0x01, 0x0a, 0x07, 0x47, 0x65, 0x74, 0x56,
	0x69, 0x65, 0x77, 0x12, 0x28, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x62, 0x69, 0x67,
	...
	0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x62, 0x69, 0x67, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x2e,
	0x61, 0x64, 0x6d, 0x69, 0x6e, 0x2e, 0x76, 0x32, 0x2e, 0x56, 0x69, 0x65, 0x77, 0x22, 0x41, 0xda,
	...
	0x61, 0x62, 0x6c, 0x65, 0x73, 0x2f, 0x2a, 0x2f, 0x76, 0x69, 0x65, 0x77, 0x73, 0x2f, 0x2a, 0x7d,
	0x12, 0xcf, 0x01, 0x0a, 0x0a, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x56, 0x69, 0x65, 0x77, 0x12,
	0x2b, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x62, 0x69, 0x67, 0x74, 0x61, 0x62, 0x6c,
	0x65, 0x2e, 0x61, 0x64, 0x6d, 0x69, 0x6e, 0x2e, 0x76, 0x32, 0x2e, 0x55, 0x70, 0x64, 0x61, 0x74,
	...
	0x0a, 0x04, 0x56, 0x69, 0x65, 0x77, 0x12, 0x12, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x56, 0x69,
	0x65, 0x77, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0xda, 0x41, 0x10, 0x76, 0x69, 0x65,
	0x77, 0x2c, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x5f, 0x6d, 0x61, 0x73, 0x6b, 0x82, 0xd3, 0xe4,
	0x93, 0x02, 0x3f, 0x3a, 0x04, 0x76, 0x69, 0x65, 0x77, 0x32, 0x37, 0x2f, 0x76, 0x32, 0x2f, 0x7b,
	...
	0x2f, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x73, 0x2f, 0x2a, 0x2f, 0x76, 0x69, 0x65, 0x77, 0x73, 0x2f,
	0x2a, 0x7d, 0x12, 0x94, 0x01, 0x0a, 0x0a, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x56, 0x69, 0x65,
	...
	0xd3, 0xe4, 0x93, 0x02, 0x34, 0x2a, 0x32, 0x2f, 0x76, 0x32, 0x2f, 0x7b, 0x6e, 0x61, 0x6d, 0x65,
	0x3d, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x73, 0x2f, 0x2a, 0x2f, 0x69, 0x6e, 0x73, 0x74,
	0x61, 0x6e, 0x63, 0x65, 0x73, 0x2f, 0x2a, 0x2f, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x73, 0x2f, 0x2a,
	0x2f, 0x76, 0x69, 0x65, 0x77, 0x73, 0x2f, 0x2a, 0x7d, 0x12, 0xcf, 0x01, 0x0a, 0x14, 0x4d, 0x6f,
...
var file_google_bigtable_admin_v2_bigtable_table_admin_proto_goTypes = []interface{}{
	...
	(*CreateViewRequest)(nil),                        // 35: google.bigtable.admin.v2.CreateViewRequest
	(*CreateViewMetadata)(nil),                       // 36: google.bigtable.admin.v2.CreateViewMetadata
	(*ListViewsRequest)(nil),                         // 37: google.bigtable.admin.v2.ListViewsRequest
	(*ListViewsResponse)(nil),                        // 38: google.bigtable.admin.v2.ListViewsResponse
	(*GetViewRequest)(nil),                           // 39: google.bigtable.admin.v2.GetViewRequest
	(*UpdateViewRequest)(nil),                        // 40: google.bigtable.admin.v2.UpdateViewRequest
	(*UpdateViewMetadata)(nil),                       // 41: google.bigtable.admin.v2.UpdateViewMetadata
	(*DeleteViewRequest)(nil),                        // 42: google.bigtable.admin.v2.DeleteViewRequest
	...
	(*View)(nil),                                     // 55: google.bigtable.admin.v2.View
	(View_ResponseView)(0),                           // 56: google.bigtable.admin.v2.View.ResponseView
...
var file_google_bigtable_admin_v2_bigtable_table_admin_proto_depIdxs = []int32{
	...
	55, // 33: google.bigtable.admin.v2.CreateViewRequest.view:type_name -> google.bigtable.admin.v2.View
	35, // 34: google.bigtable.admin.v2.CreateViewMetadata.original_request:type_name -> google.bigtable.admin.v2.CreateViewRequest
	51, // 35: google.bigtable.admin.v2.CreateViewMetadata.request_time:type_name -> google.protobuf.Timestamp
	51, // 36: google.bigtable.admin.v2.CreateViewMetadata.finish_time:type_name -> google.protobuf.Timestamp
	56, // 37: google.bigtable.admin.v2.ListViewsRequest.view:type_name -> google.bigtable.admin.v2.View.ResponseView
	55, // 38: google.bigtable.admin.v2.ListViewsResponse.views:type_name -> google.bigtable.admin.v2.View
	56, // 39: google.bigtable.admin.v2.GetViewRequest.view:type_name -> google.bigtable.admin.v2.View.ResponseView
	55, // 40: google.bigtable.admin.v2.UpdateViewRequest.view:type_name -> google.bigtable.admin.v2.View
	50, // 41: google.bigtable.admin.v2.UpdateViewRequest.update_mask:type_name -> google.protobuf.FieldMask
	40, // 42: google.bigtable.admin.v2.UpdateViewMetadata.original_request:type_name -> google.bigtable.admin.v2.UpdateViewRequest
	51, // 43: google.bigtable.admin.v2.UpdateViewMetadata.request_time:type_name -> google.protobuf.Timestamp
	51, // 44: google.bigtable.admin.v2.UpdateViewMetadata.finish_time:type_name -> google.protobuf.Timestamp
	...
	35, // 54: google.bigtable.admin.v2.BigtableTableAdmin.CreateView:input_type -> google.bigtable.admin.v2.CreateViewRequest
	37, // 55: google.bigtable.admin.v2.BigtableTableAdmin.ListViews:input_type -> google.bigtable.admin.v2.ListViewsRequest
	39, // 56: google.bigtable.admin.v2.BigtableTableAdmin.GetView:input_type -> google.bigtable.admin.v2.GetViewRequest
	40, // 57: google.bigtable.admin.v2.BigtableTableAdmin.UpdateView:input_type -> google.bigtable.admin.v2.UpdateViewRequest
	42, // 58: google.bigtable.admin.v2.BigtableTableAdmin.DeleteView:input_type -> google.bigtable.admin.v2.DeleteViewRequest
	...
	61, // 84: google.bigtable.admin.v2.BigtableTableAdmin.CreateView:output_type -> google.longrunning.Operation
	38, // 85: google.bigtable.admin.v2.BigtableTableAdmin.ListViews:output_type -> google.bigtable.admin.v2.ListViewsResponse
	55, // 86: google.bigtable.admin.v2.BigtableTableAdmin.GetView:output_type -> google.bigtable.admin.v2.View
	61, // 87: google.bigtable.admin.v2.BigtableTableAdmin.UpdateView:output_type -> google.longrunning.Operation
	62, // 88: google.bigtable.admin.v2.BigtableTableAdmin.DeleteView:output_type -> google.protobuf.Empty
...
func file_google_bigtable_admin_v2_bigtable_table_admin_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_google_bigtable_admin_v2_bigtable_table_admin_proto_msgTypes[36].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CreateViewMetadata); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_google_bigtable_admin_v2_bigtable_table_admin_proto_msgTypes[41].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UpdateViewMetadata); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
...
type BigtableTableAdminClient interface {
	...
	// Creates a new View in a table.
	CreateView(ctx context.Context, in *CreateViewRequest, opts ...grpc.CallOption) (*longrunningpb.Operation, error)
	// Lists all views from a specific table.
	ListViews(ctx context.Context, in *ListViewsRequest, opts ...grpc.CallOption) (*ListViewsResponse, error)
	// Gets information from a specified view.
	GetView(ctx context.Context, in *GetViewRequest, opts ...grpc.CallOption) (*View, error)
	// Updates a View in a table.
	UpdateView(ctx context.Context, in *UpdateViewRequest, opts ...grpc.CallOption) (*longrunningpb.Operation, error)
	// Permanently deletes a specified view.
...
func (c *bigtableTableAdminClient) CreateView(ctx context.Context, in *CreateViewRequest, opts ...grpc.CallOption) (*longrunningpb.Operation, error) {
	out := new(longrunningpb.Operation)
	err := c.cc.Invoke(ctx, "/google.bigtable.admin.v2.BigtableTableAdmin/CreateView", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bigtableTableAdminClient) ListViews(ctx context.Context, in *ListViewsRequest, opts ...grpc.CallOption) (*ListViewsResponse, error) {
	out := new(ListViewsResponse)
	err := c.cc.Invoke(ctx, "/google.bigtable.admin.v2.BigtableTableAdmin/ListViews", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bigtableTableAdminClient) GetView(ctx context.Context, in *GetViewRequest, opts ...grpc.CallOption) (*View, error) {
	out := new(View)
	err := c.cc.Invoke(ctx, "/google.bigtable.admin.v2.BigtableTableAdmin/GetView", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bigtableTableAdminClient) UpdateView(ctx context.Context, in *UpdateViewRequest, opts ...grpc.CallOption) (*longrunningpb.Operation, error) {
	out := new(longrunningpb.Operation)
	err := c.cc.Invoke(ctx, "/google.bigtable.admin.v2.BigtableTableAdmin/UpdateView", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bigtableTableAdminClient) DeleteView(ctx context.Context, in *DeleteViewRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/google.bigtable.admin.v2.BigtableTableAdmin/DeleteView", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BigtableTableAdminServer interface {
	...
	// Creates a new View in a table.
	CreateView(context.Context, *CreateViewRequest) (*longrunningpb.Operation, error)
	// Lists all views from a specific table.
	ListViews(context.Context, *ListViewsRequest) (*ListViewsResponse, error)
	// Gets information from a specified view.
	GetView(context.Context, *GetViewRequest) (*View, error)
	// Updates a View in a table.
	UpdateView(context.Context, *UpdateViewRequest) (*longrunningpb.Operation, error)
	// Permanently deletes a specified view.
...
func (*UnimplementedBigtableTableAdminServer) CreateView(context.Context, *CreateViewRequest) (*longrunningpb.Operation, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateView not implemented")
}
func (*UnimplementedBigtableTableAdminServer) ListViews(context.Context, *ListViewsRequest) (*ListViewsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListViews not implemented")
}
func (*UnimplementedBigtableTableAdminServer) GetView(context.Context, *GetViewRequest) (*View, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetView not implemented")
}
func (*UnimplementedBigtableTableAdminServer) UpdateView(context.Context, *UpdateViewRequest) (*longrunningpb.Operation, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateView not implemented")
}
func (*UnimplementedBigtableTableAdminServer) DeleteView(context.Context, *DeleteViewRequest) (*emptypb.Empty, error) {
...
func _BigtableTableAdmin_CreateView_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateViewRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BigtableTableAdminServer).CreateView(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.bigtable.admin.v2.BigtableTableAdmin/CreateView",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BigtableTableAdminServer).CreateView(ctx, req.(*CreateViewRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _BigtableTableAdmin_ListViews_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListViewsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BigtableTableAdminServer).ListViews(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.bigtable.admin.v2.BigtableTableAdmin/ListViews",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BigtableTableAdminServer).ListViews(ctx, req.(*ListViewsRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _BigtableTableAdmin_GetView_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetViewRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BigtableTableAdminServer).GetView(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.bigtable.admin.v2.BigtableTableAdmin/GetView",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BigtableTableAdminServer).GetView(ctx, req.(*GetViewRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _BigtableTableAdmin_UpdateView_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateViewRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BigtableTableAdminServer).UpdateView(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.bigtable.admin.v2.BigtableTableAdmin/UpdateView",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BigtableTableAdminServer).UpdateView(ctx, req.(*UpdateViewRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _BigtableTableAdmin_DeleteView_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteViewRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BigtableTableAdminServer).DeleteView(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.bigtable.admin.v2.BigtableTableAdmin/DeleteView",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BigtableTableAdminServer).DeleteView(ctx, req.(*DeleteViewRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _BigtableTableAdmin_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _BigtableTableAdmin_CreateView_Handler,
		},
		{
			MethodName: "ListViews",
			Handler:    _BigtableTableAdmin_ListViews_Handler,
		},
		{
			MethodName: "GetView",
			Handler:    _BigtableTableAdmin_GetView_Handler,
		},
		{
			MethodName: "UpdateView",
			Handler:    _BigtableTableAdmin_UpdateView_Handler,
		},
		{
			MethodName: "DeleteView",
			Handler:    _BigtableTableAdmin_DeleteView_Handler,
		},
		{
