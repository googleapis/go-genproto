...
func init() {
	proto.RegisterFile("google/bigtable/v1/bigtable_service.proto", fileDescriptor_bigtable_service_77c4f27ba0e27769)
}

var fileDescriptor_bigtable_service_77c4f27ba0e27769 = []byte{
