...
func (LogSeverity) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_log_severity_03d6cc62dd9e1ef9, []int{0}
}
...
func init() {
	proto.RegisterFile("google/logging/type/log_severity.proto", fileDescriptor_log_severity_03d6cc62dd9e1ef9)
}

var fileDescriptor_log_severity_03d6cc62dd9e1ef9 = []byte{
