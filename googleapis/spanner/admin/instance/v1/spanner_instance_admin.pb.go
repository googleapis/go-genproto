...
type Instance struct {
	...
	EndpointUrls         []string `protobuf:"bytes,8,rep,name=endpoint_urls,json=endpointUrls,proto3" json:"endpoint_urls,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *Instance) GetEndpointUrls() []string {
	if m != nil {
...
var fileDescriptor_3837da4dfb7336ac = []byte{
	...
	0x58, 0x35, 0xc7, 0xd6, 0x2d, 0x5a, 0x69, 0xba, 0x86, 0x97, 0x8a, 0x65, 0xa2, 0x8b, 0x71, 0x6d,
	0x52, 0x2c, 0x3e, 0x70, 0x0d, 0x2f, 0xbd, 0x0e, 0x89, 0x90, 0x2d, 0x4a, 0x42, 0xf4, 0x94, 0x9c,
	...
	0x9c, 0x4c, 0x30, 0x18, 0xef, 0xfd, 0x37, 0x00, 0x00, 0xff, 0xff, 0x17, 0x8f, 0x83, 0x0b, 0x5f,
	0x16, 0x00, 0x00,
}
