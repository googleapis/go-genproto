...
func (TypeCode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_type_aaff9ec10660d5c1, []int{0}
}
...
func (*StructType) Descriptor() ([]byte, []int) {
	return fileDescriptor_type_aaff9ec10660d5c1, []int{1}
}
...
func (*StructType_Field) Descriptor() ([]byte, []int) {
	return fileDescriptor_type_aaff9ec10660d5c1, []int{1, 0}
}
...
func init() { proto.RegisterFile("google/spanner/v1/type.proto", fileDescriptor_type_aaff9ec10660d5c1) }

var fileDescriptor_type_aaff9ec10660d5c1 = []byte{
