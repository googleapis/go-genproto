...
func (x *Slots) GetStatus() conversation.SlotFillingStatus {
	...
	return conversation.SlotFillingStatus(0)
}
...
var file_google_actions_sdk_v2_event_logs_proto_goTypes = []any{
...
func file_google_actions_sdk_v2_event_logs_proto_init() {
	...
	file_google_actions_sdk_v2_event_logs_proto_msgTypes[0].OneofWrappers = []any{
