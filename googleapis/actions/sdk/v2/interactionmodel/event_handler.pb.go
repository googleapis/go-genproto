...
var file_google_actions_sdk_v2_interactionmodel_event_handler_proto_goTypes = []any{
...
func file_google_actions_sdk_v2_interactionmodel_event_handler_proto_init() {
	...
	file_google_actions_sdk_v2_interactionmodel_event_handler_proto_msgTypes[0].OneofWrappers = []any{
