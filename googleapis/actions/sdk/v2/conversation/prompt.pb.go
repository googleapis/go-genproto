...
type Prompt struct {
	...
	//
	// Deprecated: Marked as deprecated in google/actions/sdk/v2/conversation/prompt/prompt.proto.
...
var file_google_actions_sdk_v2_conversation_prompt_prompt_proto_goTypes = []any{
