...
var file_google_firebase_fcm_connection_v1alpha1_connection_api_proto_goTypes = []any{
...
func file_google_firebase_fcm_connection_v1alpha1_connection_api_proto_init() {
	...
	file_google_firebase_fcm_connection_v1alpha1_connection_api_proto_msgTypes[0].OneofWrappers = []any{
		(*UpstreamRequest_Ack)(nil),
	}
	file_google_firebase_fcm_connection_v1alpha1_connection_api_proto_msgTypes[1].OneofWrappers = []any{
