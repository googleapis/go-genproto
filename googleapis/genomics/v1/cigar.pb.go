...
func (CigarUnit_Operation) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_cigar_2258d7e5d1ecd4a5, []int{0, 0}
}
...
func (*CigarUnit) Descriptor() ([]byte, []int) {
	return fileDescriptor_cigar_2258d7e5d1ecd4a5, []int{0}
}
...
func init() {
	proto.RegisterFile("google/genomics/v1/cigar.proto", fileDescriptor_cigar_2258d7e5d1ecd4a5)
}

var fileDescriptor_cigar_2258d7e5d1ecd4a5 = []byte{
