...
func (*LinearAlignment) Descriptor() ([]byte, []int) {
	return fileDescriptor_readalignment_631bd8edb248b735, []int{0}
}
...
func (*Read) Descriptor() ([]byte, []int) {
	return fileDescriptor_readalignment_631bd8edb248b735, []int{1}
}
...
func init() {
	proto.RegisterFile("google/genomics/v1/readalignment.proto", fileDescriptor_readalignment_631bd8edb248b735)
}

var fileDescriptor_readalignment_631bd8edb248b735 = []byte{
