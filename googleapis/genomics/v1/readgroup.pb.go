...
func (*ReadGroup) Descriptor() ([]byte, []int) {
	return fileDescriptor_readgroup_f15cee86d9a45532, []int{0}
}
...
func (*ReadGroup_Experiment) Descriptor() ([]byte, []int) {
	return fileDescriptor_readgroup_f15cee86d9a45532, []int{0, 0}
}
...
func (*ReadGroup_Program) Descriptor() ([]byte, []int) {
	return fileDescriptor_readgroup_f15cee86d9a45532, []int{0, 1}
}
...
var fileDescriptor_readgroup_f15cee86d9a45532 = []byte{
