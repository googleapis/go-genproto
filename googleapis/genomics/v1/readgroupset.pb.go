...
func (*ReadGroupSet) Descriptor() ([]byte, []int) {
	return fileDescriptor_readgroupset_b9edcdfdbb1584f9, []int{0}
}
...
func init() {
	proto.RegisterFile("google/genomics/v1/readgroupset.proto", fileDescriptor_readgroupset_b9edcdfdbb1584f9)
}

var fileDescriptor_readgroupset_b9edcdfdbb1584f9 = []byte{
