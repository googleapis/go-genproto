...
type UiDetectionRequest struct {
	...
	//
	// Deprecated: Marked as deprecated in google/chromeos/uidetection/v1/ui_detection.proto.
...
var file_google_chromeos_uidetection_v1_ui_detection_proto_goTypes = []any{
...
func file_google_chromeos_uidetection_v1_ui_detection_proto_init() {
	...
	file_google_chromeos_uidetection_v1_ui_detection_proto_msgTypes[0].OneofWrappers = []any{}
	file_google_chromeos_uidetection_v1_ui_detection_proto_msgTypes[1].OneofWrappers = []any{
	...
	file_google_chromeos_uidetection_v1_ui_detection_proto_msgTypes[3].OneofWrappers = []any{}
	file_google_chromeos_uidetection_v1_ui_detection_proto_msgTypes[4].OneofWrappers = []any{}
	type x struct{}
