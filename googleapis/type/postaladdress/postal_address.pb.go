...
func (*PostalAddress) Descriptor() ([]byte, []int) {
	return fileDescriptor_postal_address_f1ce9eb95f7d1aa5, []int{0}
}
...
func init() {
	proto.RegisterFile("google/type/postal_address.proto", fileDescriptor_postal_address_f1ce9eb95f7d1aa5)
}

var fileDescriptor_postal_address_f1ce9eb95f7d1aa5 = []byte{
