...
func (*Api) Descriptor() ([]byte, []int) {
	return fileDescriptor_6390f4cae05b0eef, []int{0}
}
...
func (*Method) Descriptor() ([]byte, []int) {
	return fileDescriptor_6390f4cae05b0eef, []int{1}
}
...
func (*Mixin) Descriptor() ([]byte, []int) {
	return fileDescriptor_6390f4cae05b0eef, []int{2}
}
...
func init() { proto.RegisterFile("src/google/protobuf/api.proto", fileDescriptor_6390f4cae05b0eef) }

var fileDescriptor_6390f4cae05b0eef = []byte{
